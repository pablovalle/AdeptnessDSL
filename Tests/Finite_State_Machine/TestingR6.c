...
int main(){
	char str[128];
    SensorInput a={1,2,3};
    double State[10]={0.033333333,3.1,5.4,10.8,15.025,10.9,17.4,11.46,13.3,9.92};
    double good[10]={6,6,9,7,8,10,6,10,10,14};
    ...
    for(int i=0; i<10; i++){
        ...
        a.good = good[i];
		a.Standby = Standby[i];
        verdict=performEvaluation_R6(&a,1,timeStamp*i);
