...
var HashMap<String, String> whileMap_preconds;
	...
	double confCalculator(double signal){
		double conf=0;
		/«IF param.check.reference.upper!==null»
		if(signal<«param.check.reference.upper.bound_upp.value.DVal»){
			conf= («param.check.reference.upper.bound_upp.value.DVal»-signal)/(«param.check.reference.upper.bound_upp.value.DVal»-minSignal);
		}
		else(){
			conf= («param.check.reference.upper.bound_upp.value.DVal»-signal)/(maxSignal-«param.check.reference.upper.bound_upp.value.DVal»);
		}
		«ELSEIF param.check.reference.lower!==null»
		if(signal>«param.check.reference.lower.bound_lower.value.DVal»){
			conf=(signal-«param.check.reference.lower.bound_lower.value.DVal»)/(maxSignal-«param.check.reference.lower.bound_lower.value.DVal»);
		}
		else(){
			conf=(signal-«param.check.reference.lower.bound_lower.value.DVal»)/(«param.check.reference.lower.bound_lower.value.DVal»-minSignal);
		}
		«ELSEIF param.check.reference.same!==null»
		if(signal==«param.check.reference.same.bound_upp.value.DVal»){
			conf=1;
		}
		else if(signal<«param.check.reference.same.bound_upp.value.DVal»){
			conf=(signal-«param.check.reference.same.bound_upp.value.DVal»)/(«param.check.reference.same.bound_upp.value.DVal»-minSignal);
		}
		else if(signal>«param.check.reference.same.bound_upp.value.DVal»){
			conf=(«param.check.reference.same.bound_upp.value.DVal»-signal)/(maxSignal-«param.check.reference.same.bound_upp.value.DVal»);
		}
		«ELSEIF param.check.reference.notsame!==null»
		if(signal==«param.check.reference.notsame.bound_upp.value.DVal»){
			conf=-1;
		}
		else if(signal<«param.check.reference.notsame.bound_upp.value.DVal»){
			conf=(«param.check.reference.notsame.bound_upp.value.DVal»-signal)/(«param.check.reference.notsame.bound_upp.value.DVal»-minSignal);
		}
		else if(signal>«param.check.reference.notsame.bound_upp.value.DVal»){
			conf=(signal-«param.check.reference.notsame.bound_upp.value.DVal»)/(«param.check.reference.notsame.bound_upp.value.DVal»-maxRef);
		}
		«ELSEIF param.check.reference.range!==null»
		if(signal<«param.check.reference.range.bound_upp.value.DVal» && signal>«param.check.reference.range.bound_lower.value.DVal» + («param.check.reference.range.bound_upp.value.DVal»-«param.check.reference.range.bound_lower.value.DVal»)/2){
			conf=(«param.check.reference.range.bound_upp.value.DVal»-signal)/((«param.check.reference.range.bound_upp.value.DVal»-«param.check.reference.range.bound_lower.value.DVal»)/2);
		}
		else if(signal>«param.check.reference.range.bound_lower.value.DVal» && signal<«param.check.reference.range.bound_lower.value.DVal» + («param.check.reference.range.bound_upp.value.DVal»-«param.check.reference.range.bound_lower.value.DVal»)/2){
			conf=(signal-«param.check.reference.range.bound_lower.value.DVal»)/((«param.check.reference.range.bound_upp.value.DVal»-«param.check.reference.range.bound_lower.value.DVal»)/2);
		}
		else if(signal<«param.check.reference.range.bound_lower.value.DVal»){
			conf=(signal-«param.check.reference.range.bound_lower.value.DVal»)/(«param.check.reference.range.bound_lower.value.DVal»-minSignal);
		}
		else if(signal>«param.check.reference.range.bound_upp.value.DVal»){
			conf=(«param.check.reference.range.bound_upp.value.DVal»-signal)/(maxSignal-«param.check.reference.range.bound_upp.value.DVal»);
		}
		«ELSEIF param.check.reference.gap!==null»
		if(signal<«param.check.reference.gap.bound_upp.value.DVal» && signal>«param.check.reference.gap.bound_lower.value.DVal» + («param.check.reference.gap.bound_upp.value.DVal»-«param.check.reference.gap.bound_lower.value.DVal»)/2){
			conf=(signal-«param.check.reference.gap.bound_upp.value.DVal»)/((«param.check.reference.gap.bound_upp.value.DVal»-«param.check.reference.gap.bound_lower.value.DVal»)/2);
		}
		else if(signal>«param.check.reference.gap.bound_lower.value.DVal» && signal<«param.check.reference.gap.bound_lower.value.DVal» + («param.check.reference.gap.bound_upp.value.DVal»-«param.check.reference.gap.bound_lower.value.DVal»)/2){
			conf=(«param.check.reference.gap.bound_lower.value.DVal»-signal)/((«param.check.reference.gap.bound_upp.value.DVal»-«param.check.reference.gap.bound_lower.value.DVal»)/2);
		}
		else if(signal<«param.check.reference.gap.bound_lower.value.DVal»){
			conf=(«param.check.reference.gap.bound_lower.value.DVal»-signal)/(«param.check.reference.gap.bound_lower.value.DVal»-minSignal);
		}
		else if(signal>«param.check.reference.gap.bound_upp.value.DVal»){
			conf=(signal-«param.check.reference.gap.bound_upp.value.DVal»)/(maxSignal-«param.check.reference.gap.bound_upp.value.DVal»);
		}
		«ENDIF»
		return conf;
	}
