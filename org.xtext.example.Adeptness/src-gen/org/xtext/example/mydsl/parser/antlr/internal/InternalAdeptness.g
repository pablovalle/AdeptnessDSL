...
@after {
	...
	(
		...
		{
			$current = $this_ValidationPlan_3.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleValidationPlan returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getValidationPlanRule()); }
	iv_ruleValidationPlan=ruleValidationPlan
	{ $current=$iv_ruleValidationPlan.current; }
	EOF;

// Rule ValidationPlan
ruleValidationPlan returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleTestingOracle returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getTestingOracleRule()); }
	iv_ruleTestingOracle=ruleTestingOracle
	{ $current=$iv_ruleTestingOracle.current; }
	EOF;

// Rule TestingOracle
ruleTestingOracle returns [EObject current=null]
@init {
	enterRule();
}
@after {
