 ...
 *   <li>{@link org.xtext.example.mydsl.adeptness.PrecondReference#getSame <em>Same</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.adeptness.PrecondReference#getNotsame <em>Notsame</em>}</li>
 * </ul>
 *
...
public interface PrecondReference extends EObject
{
   ...
   * @see #setSame(Same)
   * @see org.xtext.example.mydsl.adeptness.AdeptnessPackage#getPrecondReference_Same()
   * @model containment="true"
   * @generated
   */
  Same getSame();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.adeptness.PrecondReference#getSame <em>Same</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.adeptness.AdeptnessPackage#getPrecondReference_Notsame()
   * @model containment="true"
   * @generated
   */
  NotSame getNotsame();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.adeptness.PrecondReference#getNotsame <em>Notsame</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
