...
public class AdeptnessPackageImpl extends EPackageImpl implements AdeptnessPackage
{
   ...
   * @generated
   */
  private EClass validationPlanEClass = null;
   ...
   * @generated
   */
  private EClass testingOracleEClass = null;
   ...
   */
  @Override
  public EClass getValidationPlan()
  {
    return validationPlanEClass;
  }
   ...
   */
  @Override
  public EReference getValidationPlan_SuperType()
  {
    return (EReference)validationPlanEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getValidationPlan_Test()
  {
    return (EReference)validationPlanEClass.getEStructuralFeatures().get(1);
  }
   ...
   */
  @Override
  public EAttribute getTest_TestLevel()
  {
   ...
   */
  @Override
  public EReference getTest_Inputs()
  {
   ...
   */
  @Override
  public EReference getTest_Oracles()
  {
   ...
   */
  @Override
  public EClass getTestingOracle()
  {
    return testingOracleEClass;
  }
   ...
   */
  @Override
  public EAttribute getTestingOracle_Name()
  {
    return (EAttribute)testingOracleEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EAttribute getTestingOracle_Type()
  {
    return (EAttribute)testingOracleEClass.getEStructuralFeatures().get(1);
  }
   ...
   */
  @Override
  public EReference getTestingOracle_Parameters()
  {
    return (EReference)testingOracleEClass.getEStructuralFeatures().get(2);
  }
   ...
   */
  @Override
  public EAttribute getInputs_Value()
  {
    return (EAttribute)inputsEClass.getEStructuralFeatures().get(0);
  }
  ...
  public void createPackageContents()
  {
    ...
    validationPlanEClass = createEClass(VALIDATION_PLAN);
    createEReference(validationPlanEClass, VALIDATION_PLAN__SUPER_TYPE);
    createEReference(validationPlanEClass, VALIDATION_PLAN__TEST);

    testEClass = createEClass(TEST);
    createEAttribute(testEClass, TEST__NAME);
    createEAttribute(testEClass, TEST__SUT);
    createEAttribute(testEClass, TEST__TEST_LEVEL);
    createEReference(testEClass, TEST__INPUTS);
    createEReference(testEClass, TEST__ORACLES);

    testingOracleEClass = createEClass(TESTING_ORACLE);
    createEAttribute(testingOracleEClass, TESTING_ORACLE__NAME);
    createEAttribute(testingOracleEClass, TESTING_ORACLE__TYPE);
    createEReference(testingOracleEClass, TESTING_ORACLE__PARAMETERS);

    parametersEClass = createEClass(PARAMETERS);
    createEReference(parametersEClass, PARAMETERS__VALUE);

    inputsEClass = createEClass(INPUTS);
    createEAttribute(inputsEClass, INPUTS__VALUE);
  ...
  public void initializePackageContents()
  {
    ...
    validationPlanEClass.getESuperTypes().add(this.getType());
    ...
    initEClass(validationPlanEClass, ValidationPlan.class, "ValidationPlan", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getValidationPlan_SuperType(), this.getMonitoringFile(), null, "superType", null, 0, 1, ValidationPlan.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getValidationPlan_Test(), this.getTest(), null, "test", null, 0, -1, ValidationPlan.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getTest_Sut(), ecorePackage.getEString(), "sut", null, 0, 1, Test.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getTest_TestLevel(), ecorePackage.getEString(), "testLevel", null, 0, 1, Test.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getTest_Inputs(), this.getInputs(), null, "inputs", null, 0, -1, Test.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getTest_Oracles(), this.getTestingOracle(), null, "oracles", null, 0, -1, Test.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(testingOracleEClass, TestingOracle.class, "TestingOracle", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getTestingOracle_Name(), ecorePackage.getEString(), "name", null, 0, 1, TestingOracle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getTestingOracle_Type(), ecorePackage.getEString(), "type", null, 0, 1, TestingOracle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getTestingOracle_Parameters(), this.getParameters(), null, "parameters", null, 0, -1, TestingOracle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(parametersEClass, Parameters.class, "Parameters", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getParameters_Value(), this.getExpressionsModel(), null, "value", null, 0, 1, Parameters.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(inputsEClass, Inputs.class, "Inputs", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getInputs_Value(), ecorePackage.getEString(), "value", null, 0, 1, Inputs.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
