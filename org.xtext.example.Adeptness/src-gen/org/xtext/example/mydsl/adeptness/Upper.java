 ...
 *   <li>{@link org.xtext.example.mydsl.adeptness.Upper#getExactly <em>Exactly</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.adeptness.Upper#getAtmost <em>Atmost</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.adeptness.Upper#getAtleast <em>Atleast</em>}</li>
 * </ul>
 *
...
public interface Upper extends EObject
{
   ...
   * @see org.xtext.example.mydsl.adeptness.AdeptnessPackage#getUpper_Exactly()
   * @model containment="true"
   * @generated
   */
  Exactly getExactly();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.adeptness.Upper#getExactly <em>Exactly</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.adeptness.AdeptnessPackage#getUpper_Atmost()
   * @model containment="true"
   * @generated
   */
  At_most getAtmost();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.adeptness.Upper#getAtmost <em>Atmost</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.adeptness.AdeptnessPackage#getUpper_Atleast()
   * @model containment="true"
   * @generated
   */
  At_least getAtleast();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.adeptness.Upper#getAtleast <em>Atleast</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
