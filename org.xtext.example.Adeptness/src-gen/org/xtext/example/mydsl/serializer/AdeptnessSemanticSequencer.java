...
public class AdeptnessSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_When(ISerializationContext context, When semanticObject) {
		if (errorAcceptor != null) {
			...
			if (transientValues.isValueTransient(semanticObject, AdeptnessPackage.Literals.WHEN__AW) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, AdeptnessPackage.Literals.WHEN__AW));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getWhenAccess().getEmExpressionsModelParserRuleCall_1_0(), semanticObject.getEm());
		feeder.accept(grammarAccess.getWhenAccess().getAwAfterWhenParserRuleCall_2_0(), semanticObject.getAw());
		feeder.finish();
	}
