...
public class AdeptnessSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == AdeptnessPackage.eINSTANCE)
			...
			case AdeptnessPackage.AT_LEAST:
				sequence_At_least(context, (At_least) semanticObject); 
				return; 
			case AdeptnessPackage.AT_MOST:
				sequence_At_most(context, (At_most) semanticObject); 
				return; 
			...
			case AdeptnessPackage.PACKAGE_DECLARATION:
				...
				return; 
			case AdeptnessPackage.PARAMETERS:
			...
			case AdeptnessPackage.SIGNAL:
				...
				return; 
			case AdeptnessPackage.TEST:
				sequence_Test(context, (Test) semanticObject); 
				return; 
			case AdeptnessPackage.TESTING_ORACLE:
				sequence_TestingOracle(context, (TestingOracle) semanticObject); 
				return; 
			...
			case AdeptnessPackage.UPPER:
				...
				return; 
			case AdeptnessPackage.VALIDATION_PLAN:
				sequence_ValidationPlan(context, (ValidationPlan) semanticObject); 
				return; 
	...
	/**
	 * Contexts:
	 *     At_least returns At_least
	 *
	 * Constraint:
	 *     (value=DOUBLE ((time=DOUBLE unit=TimeType) | unit=TimeType)?)
	 */
	protected void sequence_At_least(ISerializationContext context, At_least semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     At_most returns At_most
	 *
	 * Constraint:
	 *     (value=DOUBLE ((time=DOUBLE unit=TimeType) | unit=TimeType)?)
	 */
	protected void sequence_At_most(ISerializationContext context, At_most semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	protected void sequence_Inputs(ISerializationContext context, Inputs semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, AdeptnessPackage.Literals.INPUTS__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, AdeptnessPackage.Literals.INPUTS__VALUE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getInputsAccess().getValueSTRINGTerminalRuleCall_0_0(), semanticObject.getValue());
		feeder.finish();
	}
	...
	protected void sequence_Parameters(ISerializationContext context, Parameters semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, AdeptnessPackage.Literals.PARAMETERS__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, AdeptnessPackage.Literals.PARAMETERS__VALUE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getParametersAccess().getValueExpressionsModelParserRuleCall_0_0(), semanticObject.getValue());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (name=ID sut=STRING testLevel=STRING inputs+=Inputs+ oracles+=TestingOracle+)
	 */
	...
	/**
	 * Contexts:
	 *     TestingOracle returns TestingOracle
	 *
	 * Constraint:
	 *     (name=ID type=STRING parameters+=Parameters+)
	 */
	protected void sequence_TestingOracle(ISerializationContext context, TestingOracle semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     AbstractElement returns ValidationPlan
	 *     Type returns ValidationPlan
	 *     ValidationPlan returns ValidationPlan
	 *
	 * Constraint:
	 *     (name=ID superType=[MonitoringFile|QualifiedName]? test+=Test+)
	 */
	protected void sequence_ValidationPlan(ISerializationContext context, ValidationPlan semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
