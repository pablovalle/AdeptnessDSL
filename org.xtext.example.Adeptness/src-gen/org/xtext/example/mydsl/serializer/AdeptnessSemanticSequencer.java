...
public class AdeptnessSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *
	 * Constraint:
	 *     (name=STRING reference=Reference failReason+=FailReason+ description=Description)
	 */
	 ...
	 *
	 * Constraint:
	 *     (sig_type='boolean' | sig_type='double' | sig_type='int')
	 */
	 ...
	 *
	 * Constraint:
	 *     (cant=DOUBLE nPeaks=DOUBLE time=INT unit=TimeType)
	 */
	protected void sequence_XPeaks(ISerializationContext context, XPeaks semanticObject) {
		...
		feeder.accept(grammarAccess.getXPeaksAccess().getTimeINTTerminalRuleCall_5_0(), semanticObject.getTime());
