...
public class InternalAdeptnessParser extends AbstractInternalContentAssistParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_ID", "RULE_INT", "RULE_STRING", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'boolean'", "'double'", "'int'", "'true'", "'false'", "'import'", "'.*'", "'.'", "'MONITORINGPLAN'", "':'", "'ENDMONITORINGPLAN'", "'MONITORINGVARIABLE'", "'type'", "'max:'", "'min:'", "'CPS'", "'ENDCPS'", "'ORACLE'", "'ENDORACLE'", "'checks:'", "'Description: '", "'fails if :'", "';'", "'confidence is below'", "'more than'", "'times within'", "'confidence is in constant degradation'", "'within'", "'is below'", "'is above'", "'is in range between'", "'and'", "'not in range between'", "'-'", "'datatype'", "'package'", "'{'", "'}'", "'miliseconds'", "'seconds'", "'minutes'", "'hours'"
    };
    ...
    public final void ruleAdeptness() throws RecognitionException {
        ...
        try {
            ...
            do {
                ...
                if ( (LA1_0==16||LA1_0==19||LA1_0==26||(LA1_0>=45 && LA1_0<=46)) ) {
                    alt1=1;
                }
    ...
    // InternalAdeptness.g:902:1: rule__AbstractElement__Alternatives : ( ( rulePackageDeclaration ) | ( ruleType ) | ( ruleImport ) );
    public final void rule__AbstractElement__Alternatives() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:906:1: ( ( rulePackageDeclaration ) | ( ruleType ) | ( ruleImport ) )
            int alt2=3;
            switch ( input.LA(1) ) {
            case 46:
                {
            ...
            switch (alt2) {
                ...
                case 2 :
                    ...
                    break;
                case 3 :
                    // InternalAdeptness.g:919:2: ( ruleImport )
                    {
                    // InternalAdeptness.g:919:2: ( ruleImport )
                    // InternalAdeptness.g:920:3: ruleImport
                    {
    ...
    // InternalAdeptness.g:956:1: rule__Sig_type__Sig_typeAlternatives_0 : ( ( 'boolean' ) | ( 'double' ) | ( 'int' ) );
    public final void rule__Sig_type__Sig_typeAlternatives_0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:960:1: ( ( 'boolean' ) | ( 'double' ) | ( 'int' ) )
            int alt4=3;
            switch ( input.LA(1) ) {
            case 11:
                {
            ...
            switch (alt4) {
                case 1 :
                    // InternalAdeptness.g:961:2: ( 'boolean' )
                    {
                    // InternalAdeptness.g:961:2: ( 'boolean' )
                    // InternalAdeptness.g:962:3: 'boolean'
                    {
                    ...
                    break;
                case 2 :
                    // InternalAdeptness.g:967:2: ( 'double' )
                    {
                    // InternalAdeptness.g:967:2: ( 'double' )
                    // InternalAdeptness.g:968:3: 'double'
                    {
                    ...
                    break;
                case 3 :
                    // InternalAdeptness.g:973:2: ( 'int' )
                    {
                    // InternalAdeptness.g:973:2: ( 'int' )
                    // InternalAdeptness.g:974:3: 'int'
                    {
    ...
    // InternalAdeptness.g:1103:1: rule__Import__Group__0 : rule__Import__Group__0__Impl rule__Import__Group__1 ;
    public final void rule__Import__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:1107:1: ( rule__Import__Group__0__Impl rule__Import__Group__1 )
            // InternalAdeptness.g:1108:2: rule__Import__Group__0__Impl rule__Import__Group__1
            {
            pushFollow(FOLLOW_4);
    ...
    // InternalAdeptness.g:1115:1: rule__Import__Group__0__Impl : ( 'import' ) ;
    ...
    // InternalAdeptness.g:1130:1: rule__Import__Group__1 : rule__Import__Group__1__Impl ;
    public final void rule__Import__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:1134:1: ( rule__Import__Group__1__Impl )
            // InternalAdeptness.g:1135:2: rule__Import__Group__1__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:1141:1: rule__Import__Group__1__Impl : ( ( rule__Import__ImportedNamespaceAssignment_1 ) ) ;
    public final void rule__Import__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:1145:1: ( ( ( rule__Import__ImportedNamespaceAssignment_1 ) ) )
            // InternalAdeptness.g:1146:1: ( ( rule__Import__ImportedNamespaceAssignment_1 ) )
            {
            // InternalAdeptness.g:1146:1: ( ( rule__Import__ImportedNamespaceAssignment_1 ) )
            // InternalAdeptness.g:1147:2: ( rule__Import__ImportedNamespaceAssignment_1 )
            {
             before(grammarAccess.getImportAccess().getImportedNamespaceAssignment_1()); 
            // InternalAdeptness.g:1148:2: ( rule__Import__ImportedNamespaceAssignment_1 )
            // InternalAdeptness.g:1148:3: rule__Import__ImportedNamespaceAssignment_1
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:1473:1: rule__MonitoringVariable__Group__0__Impl : ( 'MONITORINGVARIABLE' ) ;
    public final void rule__MonitoringVariable__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:1477:1: ( ( 'MONITORINGVARIABLE' ) )
            // InternalAdeptness.g:1478:1: ( 'MONITORINGVARIABLE' )
            {
            // InternalAdeptness.g:1478:1: ( 'MONITORINGVARIABLE' )
            // InternalAdeptness.g:1479:2: 'MONITORINGVARIABLE'
            {
             before(grammarAccess.getMonitoringVariableAccess().getMONITORINGVARIABLEKeyword_0()); 
            match(input,22,FOLLOW_2); 
             after(grammarAccess.getMonitoringVariableAccess().getMONITORINGVARIABLEKeyword_0()); 
    ...
    // InternalAdeptness.g:1661:1: rule__MonitoringVariable__Group__7__Impl : ( 'MONITORINGVARIABLE' ) ;
    public final void rule__MonitoringVariable__Group__7__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:1665:1: ( ( 'MONITORINGVARIABLE' ) )
            // InternalAdeptness.g:1666:1: ( 'MONITORINGVARIABLE' )
            {
            // InternalAdeptness.g:1666:1: ( 'MONITORINGVARIABLE' )
            // InternalAdeptness.g:1667:2: 'MONITORINGVARIABLE'
            {
             before(grammarAccess.getMonitoringVariableAccess().getMONITORINGVARIABLEKeyword_7()); 
            match(input,22,FOLLOW_2); 
             after(grammarAccess.getMonitoringVariableAccess().getMONITORINGVARIABLEKeyword_7()); 
    ...
    // InternalAdeptness.g:1716:1: rule__MonitoringVariable__Group_6__1__Impl : ( ( rule__MonitoringVariable__MaxAssignment_6_1 ) ) ;
    public final void rule__MonitoringVariable__Group_6__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:1720:1: ( ( ( rule__MonitoringVariable__MaxAssignment_6_1 ) ) )
            // InternalAdeptness.g:1721:1: ( ( rule__MonitoringVariable__MaxAssignment_6_1 ) )
            {
            // InternalAdeptness.g:1721:1: ( ( rule__MonitoringVariable__MaxAssignment_6_1 ) )
            // InternalAdeptness.g:1722:2: ( rule__MonitoringVariable__MaxAssignment_6_1 )
            {
             before(grammarAccess.getMonitoringVariableAccess().getMaxAssignment_6_1()); 
            // InternalAdeptness.g:1723:2: ( rule__MonitoringVariable__MaxAssignment_6_1 )
            // InternalAdeptness.g:1723:3: rule__MonitoringVariable__MaxAssignment_6_1
            {
            pushFollow(FOLLOW_2);
            rule__MonitoringVariable__MaxAssignment_6_1();
            ...
            state._fsp--;
             ...
             after(grammarAccess.getMonitoringVariableAccess().getMaxAssignment_6_1()); 
    ...
    // InternalAdeptness.g:1743:1: rule__MonitoringVariable__Group_6__2__Impl : ( 'min:' ) ;
    public final void rule__MonitoringVariable__Group_6__2__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:1747:1: ( ( 'min:' ) )
            // InternalAdeptness.g:1748:1: ( 'min:' )
            {
            // InternalAdeptness.g:1748:1: ( 'min:' )
            // InternalAdeptness.g:1749:2: 'min:'
            {
             before(grammarAccess.getMonitoringVariableAccess().getMinKeyword_6_2()); 
            match(input,25,FOLLOW_2); 
             after(grammarAccess.getMonitoringVariableAccess().getMinKeyword_6_2()); 
    ...
    // InternalAdeptness.g:1758:1: rule__MonitoringVariable__Group_6__3 : rule__MonitoringVariable__Group_6__3__Impl ;
    public final void rule__MonitoringVariable__Group_6__3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:1762:1: ( rule__MonitoringVariable__Group_6__3__Impl )
            // InternalAdeptness.g:1763:2: rule__MonitoringVariable__Group_6__3__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:1769:1: rule__MonitoringVariable__Group_6__3__Impl : ( ( rule__MonitoringVariable__MinAssignment_6_3 ) ) ;
    public final void rule__MonitoringVariable__Group_6__3__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:1773:1: ( ( ( rule__MonitoringVariable__MinAssignment_6_3 ) ) )
            // InternalAdeptness.g:1774:1: ( ( rule__MonitoringVariable__MinAssignment_6_3 ) )
            {
            // InternalAdeptness.g:1774:1: ( ( rule__MonitoringVariable__MinAssignment_6_3 ) )
            // InternalAdeptness.g:1775:2: ( rule__MonitoringVariable__MinAssignment_6_3 )
            {
             before(grammarAccess.getMonitoringVariableAccess().getMinAssignment_6_3()); 
            // InternalAdeptness.g:1776:2: ( rule__MonitoringVariable__MinAssignment_6_3 )
            // InternalAdeptness.g:1776:3: rule__MonitoringVariable__MinAssignment_6_3
            {
            pushFollow(FOLLOW_2);
            rule__MonitoringVariable__MinAssignment_6_3();
            ...
            state._fsp--;
             ...
             after(grammarAccess.getMonitoringVariableAccess().getMinAssignment_6_3()); 
    ...
    // InternalAdeptness.g:1785:1: rule__Signal__Group__0 : rule__Signal__Group__0__Impl rule__Signal__Group__1 ;
    public final void rule__Signal__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:1789:1: ( rule__Signal__Group__0__Impl rule__Signal__Group__1 )
            // InternalAdeptness.g:1790:2: rule__Signal__Group__0__Impl rule__Signal__Group__1
            {
            pushFollow(FOLLOW_4);
    ...
    // InternalAdeptness.g:1797:1: rule__Signal__Group__0__Impl : ( 'CPS' ) ;
    public final void rule__Signal__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:1801:1: ( ( 'CPS' ) )
            // InternalAdeptness.g:1802:1: ( 'CPS' )
            {
            // InternalAdeptness.g:1802:1: ( 'CPS' )
            // InternalAdeptness.g:1803:2: 'CPS'
            {
    ...
    // InternalAdeptness.g:1812:1: rule__Signal__Group__1 : rule__Signal__Group__1__Impl rule__Signal__Group__2 ;
    public final void rule__Signal__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:1816:1: ( rule__Signal__Group__1__Impl rule__Signal__Group__2 )
            // InternalAdeptness.g:1817:2: rule__Signal__Group__1__Impl rule__Signal__Group__2
            {
            pushFollow(FOLLOW_8);
    ...
    // InternalAdeptness.g:1824:1: rule__Signal__Group__1__Impl : ( ( rule__Signal__NameAssignment_1 ) ) ;
    public final void rule__Signal__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:1828:1: ( ( ( rule__Signal__NameAssignment_1 ) ) )
            // InternalAdeptness.g:1829:1: ( ( rule__Signal__NameAssignment_1 ) )
            {
            // InternalAdeptness.g:1829:1: ( ( rule__Signal__NameAssignment_1 ) )
            // InternalAdeptness.g:1830:2: ( rule__Signal__NameAssignment_1 )
            {
             before(grammarAccess.getSignalAccess().getNameAssignment_1()); 
            // InternalAdeptness.g:1831:2: ( rule__Signal__NameAssignment_1 )
            // InternalAdeptness.g:1831:3: rule__Signal__NameAssignment_1
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:1839:1: rule__Signal__Group__2 : rule__Signal__Group__2__Impl rule__Signal__Group__3 ;
    public final void rule__Signal__Group__2() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:1843:1: ( rule__Signal__Group__2__Impl rule__Signal__Group__3 )
            // InternalAdeptness.g:1844:2: rule__Signal__Group__2__Impl rule__Signal__Group__3
            {
    ...
    // InternalAdeptness.g:1851:1: rule__Signal__Group__2__Impl : ( ':' ) ;
    public final void rule__Signal__Group__2__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:1855:1: ( ( ':' ) )
            // InternalAdeptness.g:1856:1: ( ':' )
            {
            // InternalAdeptness.g:1856:1: ( ':' )
            // InternalAdeptness.g:1857:2: ':'
            {
    ...
    // InternalAdeptness.g:1866:1: rule__Signal__Group__3 : rule__Signal__Group__3__Impl rule__Signal__Group__4 ;
    public final void rule__Signal__Group__3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:1870:1: ( rule__Signal__Group__3__Impl rule__Signal__Group__4 )
            // InternalAdeptness.g:1871:2: rule__Signal__Group__3__Impl rule__Signal__Group__4
            {
    ...
    // InternalAdeptness.g:1878:1: rule__Signal__Group__3__Impl : ( ( ( rule__Signal__OracleAssignment_3 ) ) ( ( rule__Signal__OracleAssignment_3 )* ) ) ;
    public final void rule__Signal__Group__3__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:1882:1: ( ( ( ( rule__Signal__OracleAssignment_3 ) ) ( ( rule__Signal__OracleAssignment_3 )* ) ) )
            // InternalAdeptness.g:1883:1: ( ( ( rule__Signal__OracleAssignment_3 ) ) ( ( rule__Signal__OracleAssignment_3 )* ) )
            {
            // InternalAdeptness.g:1883:1: ( ( ( rule__Signal__OracleAssignment_3 ) ) ( ( rule__Signal__OracleAssignment_3 )* ) )
            // InternalAdeptness.g:1884:2: ( ( rule__Signal__OracleAssignment_3 ) ) ( ( rule__Signal__OracleAssignment_3 )* )
            {
            // InternalAdeptness.g:1884:2: ( ( rule__Signal__OracleAssignment_3 ) )
            // InternalAdeptness.g:1885:3: ( rule__Signal__OracleAssignment_3 )
            {
             before(grammarAccess.getSignalAccess().getOracleAssignment_3()); 
            // InternalAdeptness.g:1886:3: ( rule__Signal__OracleAssignment_3 )
            // InternalAdeptness.g:1886:4: rule__Signal__OracleAssignment_3
            {
            ...
            // InternalAdeptness.g:1889:2: ( ( rule__Signal__OracleAssignment_3 )* )
            // InternalAdeptness.g:1890:3: ( rule__Signal__OracleAssignment_3 )*
            {
             before(grammarAccess.getSignalAccess().getOracleAssignment_3()); 
            // InternalAdeptness.g:1891:3: ( rule__Signal__OracleAssignment_3 )*
            loop13:
            do {
                int alt13=2;
                ...
                switch (alt13) {
            	case 1 :
            	    // InternalAdeptness.g:1891:4: rule__Signal__OracleAssignment_3
            	    {
            	    pushFollow(FOLLOW_19);
            	    rule__Signal__OracleAssignment_3();
    ...
    // InternalAdeptness.g:1900:1: rule__Signal__Group__4 : rule__Signal__Group__4__Impl ;
    public final void rule__Signal__Group__4() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:1904:1: ( rule__Signal__Group__4__Impl )
            // InternalAdeptness.g:1905:2: rule__Signal__Group__4__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:1911:1: rule__Signal__Group__4__Impl : ( 'ENDCPS' ) ;
    public final void rule__Signal__Group__4__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:1915:1: ( ( 'ENDCPS' ) )
            // InternalAdeptness.g:1916:1: ( 'ENDCPS' )
            {
            // InternalAdeptness.g:1916:1: ( 'ENDCPS' )
            // InternalAdeptness.g:1917:2: 'ENDCPS'
            {
    ...
    // InternalAdeptness.g:1927:1: rule__Oracle__Group__0 : rule__Oracle__Group__0__Impl rule__Oracle__Group__1 ;
    public final void rule__Oracle__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:1931:1: ( rule__Oracle__Group__0__Impl rule__Oracle__Group__1 )
            // InternalAdeptness.g:1932:2: rule__Oracle__Group__0__Impl rule__Oracle__Group__1
            {
            pushFollow(FOLLOW_4);
    ...
    // InternalAdeptness.g:1939:1: rule__Oracle__Group__0__Impl : ( 'ORACLE' ) ;
    public final void rule__Oracle__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:1943:1: ( ( 'ORACLE' ) )
            // InternalAdeptness.g:1944:1: ( 'ORACLE' )
            {
            // InternalAdeptness.g:1944:1: ( 'ORACLE' )
            // InternalAdeptness.g:1945:2: 'ORACLE'
            {
    ...
    // InternalAdeptness.g:1954:1: rule__Oracle__Group__1 : rule__Oracle__Group__1__Impl rule__Oracle__Group__2 ;
    public final void rule__Oracle__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:1958:1: ( rule__Oracle__Group__1__Impl rule__Oracle__Group__2 )
            // InternalAdeptness.g:1959:2: rule__Oracle__Group__1__Impl rule__Oracle__Group__2
            {
            pushFollow(FOLLOW_8);
    ...
    // InternalAdeptness.g:1966:1: rule__Oracle__Group__1__Impl : ( ( rule__Oracle__NameAssignment_1 ) ) ;
    public final void rule__Oracle__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:1970:1: ( ( ( rule__Oracle__NameAssignment_1 ) ) )
            // InternalAdeptness.g:1971:1: ( ( rule__Oracle__NameAssignment_1 ) )
            {
            // InternalAdeptness.g:1971:1: ( ( rule__Oracle__NameAssignment_1 ) )
            // InternalAdeptness.g:1972:2: ( rule__Oracle__NameAssignment_1 )
            {
             before(grammarAccess.getOracleAccess().getNameAssignment_1()); 
            // InternalAdeptness.g:1973:2: ( rule__Oracle__NameAssignment_1 )
            // InternalAdeptness.g:1973:3: rule__Oracle__NameAssignment_1
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:1981:1: rule__Oracle__Group__2 : rule__Oracle__Group__2__Impl rule__Oracle__Group__3 ;
    public final void rule__Oracle__Group__2() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:1985:1: ( rule__Oracle__Group__2__Impl rule__Oracle__Group__3 )
            // InternalAdeptness.g:1986:2: rule__Oracle__Group__2__Impl rule__Oracle__Group__3
            {
    ...
    // InternalAdeptness.g:1993:1: rule__Oracle__Group__2__Impl : ( ':' ) ;
    public final void rule__Oracle__Group__2__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:1997:1: ( ( ':' ) )
            // InternalAdeptness.g:1998:1: ( ':' )
            {
            // InternalAdeptness.g:1998:1: ( ':' )
            // InternalAdeptness.g:1999:2: ':'
            {
    ...
    // InternalAdeptness.g:2008:1: rule__Oracle__Group__3 : rule__Oracle__Group__3__Impl rule__Oracle__Group__4 ;
    public final void rule__Oracle__Group__3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2012:1: ( rule__Oracle__Group__3__Impl rule__Oracle__Group__4 )
            // InternalAdeptness.g:2013:2: rule__Oracle__Group__3__Impl rule__Oracle__Group__4
            {
    ...
    // InternalAdeptness.g:2020:1: rule__Oracle__Group__3__Impl : ( ( ( rule__Oracle__CheckAssignment_3 ) ) ( ( rule__Oracle__CheckAssignment_3 )* ) ) ;
    public final void rule__Oracle__Group__3__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2024:1: ( ( ( ( rule__Oracle__CheckAssignment_3 ) ) ( ( rule__Oracle__CheckAssignment_3 )* ) ) )
            // InternalAdeptness.g:2025:1: ( ( ( rule__Oracle__CheckAssignment_3 ) ) ( ( rule__Oracle__CheckAssignment_3 )* ) )
            {
            // InternalAdeptness.g:2025:1: ( ( ( rule__Oracle__CheckAssignment_3 ) ) ( ( rule__Oracle__CheckAssignment_3 )* ) )
            // InternalAdeptness.g:2026:2: ( ( rule__Oracle__CheckAssignment_3 ) ) ( ( rule__Oracle__CheckAssignment_3 )* )
            {
            // InternalAdeptness.g:2026:2: ( ( rule__Oracle__CheckAssignment_3 ) )
            // InternalAdeptness.g:2027:3: ( rule__Oracle__CheckAssignment_3 )
            {
             before(grammarAccess.getOracleAccess().getCheckAssignment_3()); 
            // InternalAdeptness.g:2028:3: ( rule__Oracle__CheckAssignment_3 )
            // InternalAdeptness.g:2028:4: rule__Oracle__CheckAssignment_3
            {
            ...
            // InternalAdeptness.g:2031:2: ( ( rule__Oracle__CheckAssignment_3 )* )
            // InternalAdeptness.g:2032:3: ( rule__Oracle__CheckAssignment_3 )*
            {
             before(grammarAccess.getOracleAccess().getCheckAssignment_3()); 
            // InternalAdeptness.g:2033:3: ( rule__Oracle__CheckAssignment_3 )*
            loop14:
            do {
                int alt14=2;
                ...
                switch (alt14) {
            	case 1 :
            	    // InternalAdeptness.g:2033:4: rule__Oracle__CheckAssignment_3
            	    {
            	    pushFollow(FOLLOW_22);
            	    rule__Oracle__CheckAssignment_3();
    ...
    // InternalAdeptness.g:2042:1: rule__Oracle__Group__4 : rule__Oracle__Group__4__Impl ;
    public final void rule__Oracle__Group__4() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2046:1: ( rule__Oracle__Group__4__Impl )
            // InternalAdeptness.g:2047:2: rule__Oracle__Group__4__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2053:1: rule__Oracle__Group__4__Impl : ( 'ENDORACLE' ) ;
    public final void rule__Oracle__Group__4__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2057:1: ( ( 'ENDORACLE' ) )
            // InternalAdeptness.g:2058:1: ( 'ENDORACLE' )
            {
            // InternalAdeptness.g:2058:1: ( 'ENDORACLE' )
            // InternalAdeptness.g:2059:2: 'ENDORACLE'
            {
    ...
    // InternalAdeptness.g:2069:1: rule__Checks__Group__0 : rule__Checks__Group__0__Impl rule__Checks__Group__1 ;
    public final void rule__Checks__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2073:1: ( rule__Checks__Group__0__Impl rule__Checks__Group__1 )
            // InternalAdeptness.g:2074:2: rule__Checks__Group__0__Impl rule__Checks__Group__1
            {
    ...
    // InternalAdeptness.g:2081:1: rule__Checks__Group__0__Impl : ( 'checks:' ) ;
    public final void rule__Checks__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2085:1: ( ( 'checks:' ) )
            // InternalAdeptness.g:2086:1: ( 'checks:' )
            {
            // InternalAdeptness.g:2086:1: ( 'checks:' )
            // InternalAdeptness.g:2087:2: 'checks:'
            {
    ...
    // InternalAdeptness.g:2096:1: rule__Checks__Group__1 : rule__Checks__Group__1__Impl rule__Checks__Group__2 ;
    public final void rule__Checks__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2100:1: ( rule__Checks__Group__1__Impl rule__Checks__Group__2 )
            // InternalAdeptness.g:2101:2: rule__Checks__Group__1__Impl rule__Checks__Group__2
            {
    ...
    // InternalAdeptness.g:2108:1: rule__Checks__Group__1__Impl : ( ( rule__Checks__NameAssignment_1 ) ) ;
    public final void rule__Checks__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2112:1: ( ( ( rule__Checks__NameAssignment_1 ) ) )
            // InternalAdeptness.g:2113:1: ( ( rule__Checks__NameAssignment_1 ) )
            {
            // InternalAdeptness.g:2113:1: ( ( rule__Checks__NameAssignment_1 ) )
            // InternalAdeptness.g:2114:2: ( rule__Checks__NameAssignment_1 )
            {
             before(grammarAccess.getChecksAccess().getNameAssignment_1()); 
            // InternalAdeptness.g:2115:2: ( rule__Checks__NameAssignment_1 )
            // InternalAdeptness.g:2115:3: rule__Checks__NameAssignment_1
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2123:1: rule__Checks__Group__2 : rule__Checks__Group__2__Impl rule__Checks__Group__3 ;
    public final void rule__Checks__Group__2() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2127:1: ( rule__Checks__Group__2__Impl rule__Checks__Group__3 )
            // InternalAdeptness.g:2128:2: rule__Checks__Group__2__Impl rule__Checks__Group__3
            {
    ...
    // InternalAdeptness.g:2135:1: rule__Checks__Group__2__Impl : ( ( rule__Checks__ReferenceAssignment_2 ) ) ;
    public final void rule__Checks__Group__2__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2139:1: ( ( ( rule__Checks__ReferenceAssignment_2 ) ) )
            // InternalAdeptness.g:2140:1: ( ( rule__Checks__ReferenceAssignment_2 ) )
            {
            // InternalAdeptness.g:2140:1: ( ( rule__Checks__ReferenceAssignment_2 ) )
            // InternalAdeptness.g:2141:2: ( rule__Checks__ReferenceAssignment_2 )
            {
             before(grammarAccess.getChecksAccess().getReferenceAssignment_2()); 
            // InternalAdeptness.g:2142:2: ( rule__Checks__ReferenceAssignment_2 )
            // InternalAdeptness.g:2142:3: rule__Checks__ReferenceAssignment_2
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2150:1: rule__Checks__Group__3 : rule__Checks__Group__3__Impl rule__Checks__Group__4 ;
    public final void rule__Checks__Group__3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2154:1: ( rule__Checks__Group__3__Impl rule__Checks__Group__4 )
            // InternalAdeptness.g:2155:2: rule__Checks__Group__3__Impl rule__Checks__Group__4
            {
    ...
    // InternalAdeptness.g:2162:1: rule__Checks__Group__3__Impl : ( ( ( rule__Checks__FailReasonAssignment_3 ) ) ( ( rule__Checks__FailReasonAssignment_3 )* ) ) ;
    public final void rule__Checks__Group__3__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2166:1: ( ( ( ( rule__Checks__FailReasonAssignment_3 ) ) ( ( rule__Checks__FailReasonAssignment_3 )* ) ) )
            // InternalAdeptness.g:2167:1: ( ( ( rule__Checks__FailReasonAssignment_3 ) ) ( ( rule__Checks__FailReasonAssignment_3 )* ) )
            {
            // InternalAdeptness.g:2167:1: ( ( ( rule__Checks__FailReasonAssignment_3 ) ) ( ( rule__Checks__FailReasonAssignment_3 )* ) )
            // InternalAdeptness.g:2168:2: ( ( rule__Checks__FailReasonAssignment_3 ) ) ( ( rule__Checks__FailReasonAssignment_3 )* )
            {
            // InternalAdeptness.g:2168:2: ( ( rule__Checks__FailReasonAssignment_3 ) )
            // InternalAdeptness.g:2169:3: ( rule__Checks__FailReasonAssignment_3 )
            {
             before(grammarAccess.getChecksAccess().getFailReasonAssignment_3()); 
            // InternalAdeptness.g:2170:3: ( rule__Checks__FailReasonAssignment_3 )
            // InternalAdeptness.g:2170:4: rule__Checks__FailReasonAssignment_3
            {
            ...
            // InternalAdeptness.g:2173:2: ( ( rule__Checks__FailReasonAssignment_3 )* )
            // InternalAdeptness.g:2174:3: ( rule__Checks__FailReasonAssignment_3 )*
            {
             before(grammarAccess.getChecksAccess().getFailReasonAssignment_3()); 
            // InternalAdeptness.g:2175:3: ( rule__Checks__FailReasonAssignment_3 )*
            loop15:
            do {
                int alt15=2;
                ...
                switch (alt15) {
            	case 1 :
            	    // InternalAdeptness.g:2175:4: rule__Checks__FailReasonAssignment_3
            	    {
            	    pushFollow(FOLLOW_27);
            	    rule__Checks__FailReasonAssignment_3();
    ...
    // InternalAdeptness.g:2184:1: rule__Checks__Group__4 : rule__Checks__Group__4__Impl ;
    public final void rule__Checks__Group__4() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2188:1: ( rule__Checks__Group__4__Impl )
            // InternalAdeptness.g:2189:2: rule__Checks__Group__4__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2195:1: rule__Checks__Group__4__Impl : ( ( rule__Checks__DescriptionAssignment_4 ) ) ;
    public final void rule__Checks__Group__4__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2199:1: ( ( ( rule__Checks__DescriptionAssignment_4 ) ) )
            // InternalAdeptness.g:2200:1: ( ( rule__Checks__DescriptionAssignment_4 ) )
            {
            // InternalAdeptness.g:2200:1: ( ( rule__Checks__DescriptionAssignment_4 ) )
            // InternalAdeptness.g:2201:2: ( rule__Checks__DescriptionAssignment_4 )
            {
             before(grammarAccess.getChecksAccess().getDescriptionAssignment_4()); 
            // InternalAdeptness.g:2202:2: ( rule__Checks__DescriptionAssignment_4 )
            // InternalAdeptness.g:2202:3: rule__Checks__DescriptionAssignment_4
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2211:1: rule__Description__Group__0 : rule__Description__Group__0__Impl rule__Description__Group__1 ;
    public final void rule__Description__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2215:1: ( rule__Description__Group__0__Impl rule__Description__Group__1 )
            // InternalAdeptness.g:2216:2: rule__Description__Group__0__Impl rule__Description__Group__1
            {
            pushFollow(FOLLOW_23);
    ...
    // InternalAdeptness.g:2223:1: rule__Description__Group__0__Impl : ( 'Description: ' ) ;
    public final void rule__Description__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2227:1: ( ( 'Description: ' ) )
            // InternalAdeptness.g:2228:1: ( 'Description: ' )
            {
            // InternalAdeptness.g:2228:1: ( 'Description: ' )
            // InternalAdeptness.g:2229:2: 'Description: '
            {
    ...
    // InternalAdeptness.g:2238:1: rule__Description__Group__1 : rule__Description__Group__1__Impl ;
    public final void rule__Description__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2242:1: ( rule__Description__Group__1__Impl )
            // InternalAdeptness.g:2243:2: rule__Description__Group__1__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2249:1: rule__Description__Group__1__Impl : ( ( rule__Description__ValueAssignment_1 ) ) ;
    public final void rule__Description__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2253:1: ( ( ( rule__Description__ValueAssignment_1 ) ) )
            // InternalAdeptness.g:2254:1: ( ( rule__Description__ValueAssignment_1 ) )
            {
            // InternalAdeptness.g:2254:1: ( ( rule__Description__ValueAssignment_1 ) )
            // InternalAdeptness.g:2255:2: ( rule__Description__ValueAssignment_1 )
            {
             before(grammarAccess.getDescriptionAccess().getValueAssignment_1()); 
            // InternalAdeptness.g:2256:2: ( rule__Description__ValueAssignment_1 )
            // InternalAdeptness.g:2256:3: rule__Description__ValueAssignment_1
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2265:1: rule__FailReason__Group__0 : rule__FailReason__Group__0__Impl rule__FailReason__Group__1 ;
    public final void rule__FailReason__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2269:1: ( rule__FailReason__Group__0__Impl rule__FailReason__Group__1 )
            // InternalAdeptness.g:2270:2: rule__FailReason__Group__0__Impl rule__FailReason__Group__1
            {
    ...
    // InternalAdeptness.g:2277:1: rule__FailReason__Group__0__Impl : ( 'fails if :' ) ;
    public final void rule__FailReason__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2281:1: ( ( 'fails if :' ) )
            // InternalAdeptness.g:2282:1: ( 'fails if :' )
            {
            // InternalAdeptness.g:2282:1: ( 'fails if :' )
            // InternalAdeptness.g:2283:2: 'fails if :'
            {
    ...
    // InternalAdeptness.g:2292:1: rule__FailReason__Group__1 : rule__FailReason__Group__1__Impl ;
    public final void rule__FailReason__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2296:1: ( rule__FailReason__Group__1__Impl )
            // InternalAdeptness.g:2297:2: rule__FailReason__Group__1__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2303:1: rule__FailReason__Group__1__Impl : ( ( rule__FailReason__ReasonAssignment_1 ) ) ;
    public final void rule__FailReason__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2307:1: ( ( ( rule__FailReason__ReasonAssignment_1 ) ) )
            // InternalAdeptness.g:2308:1: ( ( rule__FailReason__ReasonAssignment_1 ) )
            {
            // InternalAdeptness.g:2308:1: ( ( rule__FailReason__ReasonAssignment_1 ) )
            // InternalAdeptness.g:2309:2: ( rule__FailReason__ReasonAssignment_1 )
            {
             before(grammarAccess.getFailReasonAccess().getReasonAssignment_1()); 
            // InternalAdeptness.g:2310:2: ( rule__FailReason__ReasonAssignment_1 )
            // InternalAdeptness.g:2310:3: rule__FailReason__ReasonAssignment_1
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2319:1: rule__Reason__Group__0 : rule__Reason__Group__0__Impl rule__Reason__Group__1 ;
    public final void rule__Reason__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2323:1: ( rule__Reason__Group__0__Impl rule__Reason__Group__1 )
            // InternalAdeptness.g:2324:2: rule__Reason__Group__0__Impl rule__Reason__Group__1
            {
    ...
    // InternalAdeptness.g:2331:1: rule__Reason__Group__0__Impl : ( ( rule__Reason__Alternatives_0 ) ) ;
    public final void rule__Reason__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2335:1: ( ( ( rule__Reason__Alternatives_0 ) ) )
            // InternalAdeptness.g:2336:1: ( ( rule__Reason__Alternatives_0 ) )
            {
            // InternalAdeptness.g:2336:1: ( ( rule__Reason__Alternatives_0 ) )
            // InternalAdeptness.g:2337:2: ( rule__Reason__Alternatives_0 )
            {
             before(grammarAccess.getReasonAccess().getAlternatives_0()); 
            // InternalAdeptness.g:2338:2: ( rule__Reason__Alternatives_0 )
            // InternalAdeptness.g:2338:3: rule__Reason__Alternatives_0
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2346:1: rule__Reason__Group__1 : rule__Reason__Group__1__Impl ;
    public final void rule__Reason__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2350:1: ( rule__Reason__Group__1__Impl )
            // InternalAdeptness.g:2351:2: rule__Reason__Group__1__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2357:1: rule__Reason__Group__1__Impl : ( ';' ) ;
    public final void rule__Reason__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2361:1: ( ( ';' ) )
            // InternalAdeptness.g:2362:1: ( ';' )
            {
            // InternalAdeptness.g:2362:1: ( ';' )
            // InternalAdeptness.g:2363:2: ';'
            {
    ...
    // InternalAdeptness.g:2373:1: rule__XPeaks__Group__0 : rule__XPeaks__Group__0__Impl rule__XPeaks__Group__1 ;
    public final void rule__XPeaks__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2377:1: ( rule__XPeaks__Group__0__Impl rule__XPeaks__Group__1 )
            // InternalAdeptness.g:2378:2: rule__XPeaks__Group__0__Impl rule__XPeaks__Group__1
            {
            pushFollow(FOLLOW_15);
    ...
    // InternalAdeptness.g:2385:1: rule__XPeaks__Group__0__Impl : ( 'confidence is below' ) ;
    public final void rule__XPeaks__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2389:1: ( ( 'confidence is below' ) )
            // InternalAdeptness.g:2390:1: ( 'confidence is below' )
            {
            // InternalAdeptness.g:2390:1: ( 'confidence is below' )
            // InternalAdeptness.g:2391:2: 'confidence is below'
            {
    ...
    // InternalAdeptness.g:2400:1: rule__XPeaks__Group__1 : rule__XPeaks__Group__1__Impl rule__XPeaks__Group__2 ;
    public final void rule__XPeaks__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2404:1: ( rule__XPeaks__Group__1__Impl rule__XPeaks__Group__2 )
            // InternalAdeptness.g:2405:2: rule__XPeaks__Group__1__Impl rule__XPeaks__Group__2
            {
    ...
    // InternalAdeptness.g:2412:1: rule__XPeaks__Group__1__Impl : ( ( rule__XPeaks__CantAssignment_1 ) ) ;
    public final void rule__XPeaks__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2416:1: ( ( ( rule__XPeaks__CantAssignment_1 ) ) )
            // InternalAdeptness.g:2417:1: ( ( rule__XPeaks__CantAssignment_1 ) )
            {
            // InternalAdeptness.g:2417:1: ( ( rule__XPeaks__CantAssignment_1 ) )
            // InternalAdeptness.g:2418:2: ( rule__XPeaks__CantAssignment_1 )
            {
             before(grammarAccess.getXPeaksAccess().getCantAssignment_1()); 
            // InternalAdeptness.g:2419:2: ( rule__XPeaks__CantAssignment_1 )
            // InternalAdeptness.g:2419:3: rule__XPeaks__CantAssignment_1
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2427:1: rule__XPeaks__Group__2 : rule__XPeaks__Group__2__Impl rule__XPeaks__Group__3 ;
    public final void rule__XPeaks__Group__2() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2431:1: ( rule__XPeaks__Group__2__Impl rule__XPeaks__Group__3 )
            // InternalAdeptness.g:2432:2: rule__XPeaks__Group__2__Impl rule__XPeaks__Group__3
            {
            pushFollow(FOLLOW_15);
    ...
    // InternalAdeptness.g:2439:1: rule__XPeaks__Group__2__Impl : ( 'more than' ) ;
    public final void rule__XPeaks__Group__2__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2443:1: ( ( 'more than' ) )
            // InternalAdeptness.g:2444:1: ( 'more than' )
            {
            // InternalAdeptness.g:2444:1: ( 'more than' )
            // InternalAdeptness.g:2445:2: 'more than'
            {
    ...
    // InternalAdeptness.g:2454:1: rule__XPeaks__Group__3 : rule__XPeaks__Group__3__Impl rule__XPeaks__Group__4 ;
    public final void rule__XPeaks__Group__3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2458:1: ( rule__XPeaks__Group__3__Impl rule__XPeaks__Group__4 )
            // InternalAdeptness.g:2459:2: rule__XPeaks__Group__3__Impl rule__XPeaks__Group__4
            {
    ...
    // InternalAdeptness.g:2466:1: rule__XPeaks__Group__3__Impl : ( ( rule__XPeaks__NPeaksAssignment_3 ) ) ;
    public final void rule__XPeaks__Group__3__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2470:1: ( ( ( rule__XPeaks__NPeaksAssignment_3 ) ) )
            // InternalAdeptness.g:2471:1: ( ( rule__XPeaks__NPeaksAssignment_3 ) )
            {
            // InternalAdeptness.g:2471:1: ( ( rule__XPeaks__NPeaksAssignment_3 ) )
            // InternalAdeptness.g:2472:2: ( rule__XPeaks__NPeaksAssignment_3 )
            {
             before(grammarAccess.getXPeaksAccess().getNPeaksAssignment_3()); 
            // InternalAdeptness.g:2473:2: ( rule__XPeaks__NPeaksAssignment_3 )
            // InternalAdeptness.g:2473:3: rule__XPeaks__NPeaksAssignment_3
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2481:1: rule__XPeaks__Group__4 : rule__XPeaks__Group__4__Impl rule__XPeaks__Group__5 ;
    public final void rule__XPeaks__Group__4() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2485:1: ( rule__XPeaks__Group__4__Impl rule__XPeaks__Group__5 )
            // InternalAdeptness.g:2486:2: rule__XPeaks__Group__4__Impl rule__XPeaks__Group__5
            {
    ...
    // InternalAdeptness.g:2493:1: rule__XPeaks__Group__4__Impl : ( 'times within' ) ;
    public final void rule__XPeaks__Group__4__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2497:1: ( ( 'times within' ) )
            // InternalAdeptness.g:2498:1: ( 'times within' )
            {
            // InternalAdeptness.g:2498:1: ( 'times within' )
            // InternalAdeptness.g:2499:2: 'times within'
            {
    ...
    // InternalAdeptness.g:2508:1: rule__XPeaks__Group__5 : rule__XPeaks__Group__5__Impl rule__XPeaks__Group__6 ;
    public final void rule__XPeaks__Group__5() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2512:1: ( rule__XPeaks__Group__5__Impl rule__XPeaks__Group__6 )
            // InternalAdeptness.g:2513:2: rule__XPeaks__Group__5__Impl rule__XPeaks__Group__6
            {
    ...
    // InternalAdeptness.g:2520:1: rule__XPeaks__Group__5__Impl : ( ( rule__XPeaks__TimeAssignment_5 ) ) ;
    public final void rule__XPeaks__Group__5__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2524:1: ( ( ( rule__XPeaks__TimeAssignment_5 ) ) )
            // InternalAdeptness.g:2525:1: ( ( rule__XPeaks__TimeAssignment_5 ) )
            {
            // InternalAdeptness.g:2525:1: ( ( rule__XPeaks__TimeAssignment_5 ) )
            // InternalAdeptness.g:2526:2: ( rule__XPeaks__TimeAssignment_5 )
            {
             before(grammarAccess.getXPeaksAccess().getTimeAssignment_5()); 
            // InternalAdeptness.g:2527:2: ( rule__XPeaks__TimeAssignment_5 )
            // InternalAdeptness.g:2527:3: rule__XPeaks__TimeAssignment_5
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2535:1: rule__XPeaks__Group__6 : rule__XPeaks__Group__6__Impl ;
    public final void rule__XPeaks__Group__6() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2539:1: ( rule__XPeaks__Group__6__Impl )
            // InternalAdeptness.g:2540:2: rule__XPeaks__Group__6__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2546:1: rule__XPeaks__Group__6__Impl : ( ( rule__XPeaks__UnitAssignment_6 ) ) ;
    public final void rule__XPeaks__Group__6__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2550:1: ( ( ( rule__XPeaks__UnitAssignment_6 ) ) )
            // InternalAdeptness.g:2551:1: ( ( rule__XPeaks__UnitAssignment_6 ) )
            {
            // InternalAdeptness.g:2551:1: ( ( rule__XPeaks__UnitAssignment_6 ) )
            // InternalAdeptness.g:2552:2: ( rule__XPeaks__UnitAssignment_6 )
            {
             before(grammarAccess.getXPeaksAccess().getUnitAssignment_6()); 
            // InternalAdeptness.g:2553:2: ( rule__XPeaks__UnitAssignment_6 )
            // InternalAdeptness.g:2553:3: rule__XPeaks__UnitAssignment_6
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2562:1: rule__ConstDeg__Group__0 : rule__ConstDeg__Group__0__Impl rule__ConstDeg__Group__1 ;
    public final void rule__ConstDeg__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2566:1: ( rule__ConstDeg__Group__0__Impl rule__ConstDeg__Group__1 )
            // InternalAdeptness.g:2567:2: rule__ConstDeg__Group__0__Impl rule__ConstDeg__Group__1
            {
            pushFollow(FOLLOW_15);
    ...
    // InternalAdeptness.g:2574:1: rule__ConstDeg__Group__0__Impl : ( 'confidence is in constant degradation' ) ;
    public final void rule__ConstDeg__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2578:1: ( ( 'confidence is in constant degradation' ) )
            // InternalAdeptness.g:2579:1: ( 'confidence is in constant degradation' )
            {
            // InternalAdeptness.g:2579:1: ( 'confidence is in constant degradation' )
            // InternalAdeptness.g:2580:2: 'confidence is in constant degradation'
            {
    ...
    // InternalAdeptness.g:2589:1: rule__ConstDeg__Group__1 : rule__ConstDeg__Group__1__Impl ;
    public final void rule__ConstDeg__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2593:1: ( rule__ConstDeg__Group__1__Impl )
            // InternalAdeptness.g:2594:2: rule__ConstDeg__Group__1__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2600:1: rule__ConstDeg__Group__1__Impl : ( ( rule__ConstDeg__CantAssignment_1 ) ) ;
    public final void rule__ConstDeg__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2604:1: ( ( ( rule__ConstDeg__CantAssignment_1 ) ) )
            // InternalAdeptness.g:2605:1: ( ( rule__ConstDeg__CantAssignment_1 ) )
            {
            // InternalAdeptness.g:2605:1: ( ( rule__ConstDeg__CantAssignment_1 ) )
            // InternalAdeptness.g:2606:2: ( rule__ConstDeg__CantAssignment_1 )
            {
             before(grammarAccess.getConstDegAccess().getCantAssignment_1()); 
            // InternalAdeptness.g:2607:2: ( rule__ConstDeg__CantAssignment_1 )
            // InternalAdeptness.g:2607:3: rule__ConstDeg__CantAssignment_1
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2616:1: rule__HighTime__Group__0 : rule__HighTime__Group__0__Impl rule__HighTime__Group__1 ;
    public final void rule__HighTime__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2620:1: ( rule__HighTime__Group__0__Impl rule__HighTime__Group__1 )
            // InternalAdeptness.g:2621:2: rule__HighTime__Group__0__Impl rule__HighTime__Group__1
            {
            pushFollow(FOLLOW_15);
    ...
    // InternalAdeptness.g:2628:1: rule__HighTime__Group__0__Impl : ( 'confidence is below' ) ;
    ...
    // InternalAdeptness.g:2643:1: rule__HighTime__Group__1 : rule__HighTime__Group__1__Impl rule__HighTime__Group__2 ;
    public final void rule__HighTime__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2647:1: ( rule__HighTime__Group__1__Impl rule__HighTime__Group__2 )
            // InternalAdeptness.g:2648:2: rule__HighTime__Group__1__Impl rule__HighTime__Group__2
            {
    ...
    // InternalAdeptness.g:2655:1: rule__HighTime__Group__1__Impl : ( ( rule__HighTime__CantAssignment_1 ) ) ;
    public final void rule__HighTime__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2659:1: ( ( ( rule__HighTime__CantAssignment_1 ) ) )
            // InternalAdeptness.g:2660:1: ( ( rule__HighTime__CantAssignment_1 ) )
            {
            // InternalAdeptness.g:2660:1: ( ( rule__HighTime__CantAssignment_1 ) )
            // InternalAdeptness.g:2661:2: ( rule__HighTime__CantAssignment_1 )
            {
             before(grammarAccess.getHighTimeAccess().getCantAssignment_1()); 
            // InternalAdeptness.g:2662:2: ( rule__HighTime__CantAssignment_1 )
            // InternalAdeptness.g:2662:3: rule__HighTime__CantAssignment_1
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2670:1: rule__HighTime__Group__2 : rule__HighTime__Group__2__Impl rule__HighTime__Group__3 ;
    public final void rule__HighTime__Group__2() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2674:1: ( rule__HighTime__Group__2__Impl rule__HighTime__Group__3 )
            // InternalAdeptness.g:2675:2: rule__HighTime__Group__2__Impl rule__HighTime__Group__3
            {
            pushFollow(FOLLOW_15);
    ...
    // InternalAdeptness.g:2682:1: rule__HighTime__Group__2__Impl : ( 'within' ) ;
    public final void rule__HighTime__Group__2__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2686:1: ( ( 'within' ) )
            // InternalAdeptness.g:2687:1: ( 'within' )
            {
            // InternalAdeptness.g:2687:1: ( 'within' )
            // InternalAdeptness.g:2688:2: 'within'
            {
    ...
    // InternalAdeptness.g:2697:1: rule__HighTime__Group__3 : rule__HighTime__Group__3__Impl rule__HighTime__Group__4 ;
    public final void rule__HighTime__Group__3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2701:1: ( rule__HighTime__Group__3__Impl rule__HighTime__Group__4 )
            // InternalAdeptness.g:2702:2: rule__HighTime__Group__3__Impl rule__HighTime__Group__4
            {
            pushFollow(FOLLOW_33);
    ...
    // InternalAdeptness.g:2709:1: rule__HighTime__Group__3__Impl : ( ( rule__HighTime__TimeAssignment_3 ) ) ;
    public final void rule__HighTime__Group__3__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2713:1: ( ( ( rule__HighTime__TimeAssignment_3 ) ) )
            // InternalAdeptness.g:2714:1: ( ( rule__HighTime__TimeAssignment_3 ) )
            {
            // InternalAdeptness.g:2714:1: ( ( rule__HighTime__TimeAssignment_3 ) )
            // InternalAdeptness.g:2715:2: ( rule__HighTime__TimeAssignment_3 )
            {
             before(grammarAccess.getHighTimeAccess().getTimeAssignment_3()); 
            // InternalAdeptness.g:2716:2: ( rule__HighTime__TimeAssignment_3 )
            // InternalAdeptness.g:2716:3: rule__HighTime__TimeAssignment_3
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2724:1: rule__HighTime__Group__4 : rule__HighTime__Group__4__Impl ;
    public final void rule__HighTime__Group__4() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2728:1: ( rule__HighTime__Group__4__Impl )
            // InternalAdeptness.g:2729:2: rule__HighTime__Group__4__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2735:1: rule__HighTime__Group__4__Impl : ( ( rule__HighTime__UnitAssignment_4 ) ) ;
    public final void rule__HighTime__Group__4__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2739:1: ( ( ( rule__HighTime__UnitAssignment_4 ) ) )
            // InternalAdeptness.g:2740:1: ( ( rule__HighTime__UnitAssignment_4 ) )
            {
            // InternalAdeptness.g:2740:1: ( ( rule__HighTime__UnitAssignment_4 ) )
            // InternalAdeptness.g:2741:2: ( rule__HighTime__UnitAssignment_4 )
            {
             before(grammarAccess.getHighTimeAccess().getUnitAssignment_4()); 
            // InternalAdeptness.g:2742:2: ( rule__HighTime__UnitAssignment_4 )
            // InternalAdeptness.g:2742:3: rule__HighTime__UnitAssignment_4
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2751:1: rule__HighPeak__Group__0 : rule__HighPeak__Group__0__Impl rule__HighPeak__Group__1 ;
    public final void rule__HighPeak__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2755:1: ( rule__HighPeak__Group__0__Impl rule__HighPeak__Group__1 )
            // InternalAdeptness.g:2756:2: rule__HighPeak__Group__0__Impl rule__HighPeak__Group__1
            {
            pushFollow(FOLLOW_15);
    ...
    // InternalAdeptness.g:2763:1: rule__HighPeak__Group__0__Impl : ( 'confidence is below' ) ;
    ...
    // InternalAdeptness.g:2778:1: rule__HighPeak__Group__1 : rule__HighPeak__Group__1__Impl ;
    public final void rule__HighPeak__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2782:1: ( rule__HighPeak__Group__1__Impl )
            // InternalAdeptness.g:2783:2: rule__HighPeak__Group__1__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2789:1: rule__HighPeak__Group__1__Impl : ( ( rule__HighPeak__CantAssignment_1 ) ) ;
    public final void rule__HighPeak__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2793:1: ( ( ( rule__HighPeak__CantAssignment_1 ) ) )
            // InternalAdeptness.g:2794:1: ( ( rule__HighPeak__CantAssignment_1 ) )
            {
            // InternalAdeptness.g:2794:1: ( ( rule__HighPeak__CantAssignment_1 ) )
            // InternalAdeptness.g:2795:2: ( rule__HighPeak__CantAssignment_1 )
            {
             before(grammarAccess.getHighPeakAccess().getCantAssignment_1()); 
            // InternalAdeptness.g:2796:2: ( rule__HighPeak__CantAssignment_1 )
            // InternalAdeptness.g:2796:3: rule__HighPeak__CantAssignment_1
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2805:1: rule__Reference__Group__0 : rule__Reference__Group__0__Impl rule__Reference__Group__1 ;
    public final void rule__Reference__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2809:1: ( rule__Reference__Group__0__Impl rule__Reference__Group__1 )
            // InternalAdeptness.g:2810:2: rule__Reference__Group__0__Impl rule__Reference__Group__1
            {
            pushFollow(FOLLOW_29);
    ...
    // InternalAdeptness.g:2817:1: rule__Reference__Group__0__Impl : ( ( rule__Reference__Alternatives_0 ) ) ;
    public final void rule__Reference__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2821:1: ( ( ( rule__Reference__Alternatives_0 ) ) )
            // InternalAdeptness.g:2822:1: ( ( rule__Reference__Alternatives_0 ) )
            {
            // InternalAdeptness.g:2822:1: ( ( rule__Reference__Alternatives_0 ) )
            // InternalAdeptness.g:2823:2: ( rule__Reference__Alternatives_0 )
            {
             before(grammarAccess.getReferenceAccess().getAlternatives_0()); 
            // InternalAdeptness.g:2824:2: ( rule__Reference__Alternatives_0 )
            // InternalAdeptness.g:2824:3: rule__Reference__Alternatives_0
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2832:1: rule__Reference__Group__1 : rule__Reference__Group__1__Impl ;
    public final void rule__Reference__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2836:1: ( rule__Reference__Group__1__Impl )
            // InternalAdeptness.g:2837:2: rule__Reference__Group__1__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2843:1: rule__Reference__Group__1__Impl : ( ';' ) ;
    public final void rule__Reference__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2847:1: ( ( ';' ) )
            // InternalAdeptness.g:2848:1: ( ';' )
            {
            // InternalAdeptness.g:2848:1: ( ';' )
            // InternalAdeptness.g:2849:2: ';'
            {
    ...
    // InternalAdeptness.g:2859:1: rule__Upper__Group__0 : rule__Upper__Group__0__Impl rule__Upper__Group__1 ;
    public final void rule__Upper__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2863:1: ( rule__Upper__Group__0__Impl rule__Upper__Group__1 )
            // InternalAdeptness.g:2864:2: rule__Upper__Group__0__Impl rule__Upper__Group__1
            {
            pushFollow(FOLLOW_15);
    ...
    // InternalAdeptness.g:2871:1: rule__Upper__Group__0__Impl : ( 'is below' ) ;
    public final void rule__Upper__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2875:1: ( ( 'is below' ) )
            // InternalAdeptness.g:2876:1: ( 'is below' )
            {
            // InternalAdeptness.g:2876:1: ( 'is below' )
            // InternalAdeptness.g:2877:2: 'is below'
            {
    ...
    // InternalAdeptness.g:2886:1: rule__Upper__Group__1 : rule__Upper__Group__1__Impl ;
    public final void rule__Upper__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2890:1: ( rule__Upper__Group__1__Impl )
            // InternalAdeptness.g:2891:2: rule__Upper__Group__1__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2897:1: rule__Upper__Group__1__Impl : ( ( rule__Upper__Bound_uppAssignment_1 ) ) ;
    public final void rule__Upper__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2901:1: ( ( ( rule__Upper__Bound_uppAssignment_1 ) ) )
            // InternalAdeptness.g:2902:1: ( ( rule__Upper__Bound_uppAssignment_1 ) )
            {
            // InternalAdeptness.g:2902:1: ( ( rule__Upper__Bound_uppAssignment_1 ) )
            // InternalAdeptness.g:2903:2: ( rule__Upper__Bound_uppAssignment_1 )
            {
             before(grammarAccess.getUpperAccess().getBound_uppAssignment_1()); 
            // InternalAdeptness.g:2904:2: ( rule__Upper__Bound_uppAssignment_1 )
            // InternalAdeptness.g:2904:3: rule__Upper__Bound_uppAssignment_1
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2913:1: rule__Lower__Group__0 : rule__Lower__Group__0__Impl rule__Lower__Group__1 ;
    public final void rule__Lower__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2917:1: ( rule__Lower__Group__0__Impl rule__Lower__Group__1 )
            // InternalAdeptness.g:2918:2: rule__Lower__Group__0__Impl rule__Lower__Group__1
            {
            pushFollow(FOLLOW_15);
    ...
    // InternalAdeptness.g:2925:1: rule__Lower__Group__0__Impl : ( 'is above' ) ;
    public final void rule__Lower__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2929:1: ( ( 'is above' ) )
            // InternalAdeptness.g:2930:1: ( 'is above' )
            {
            // InternalAdeptness.g:2930:1: ( 'is above' )
            // InternalAdeptness.g:2931:2: 'is above'
            {
    ...
    // InternalAdeptness.g:2940:1: rule__Lower__Group__1 : rule__Lower__Group__1__Impl ;
    public final void rule__Lower__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2944:1: ( rule__Lower__Group__1__Impl )
            // InternalAdeptness.g:2945:2: rule__Lower__Group__1__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2951:1: rule__Lower__Group__1__Impl : ( ( rule__Lower__Bound_lowerAssignment_1 ) ) ;
    public final void rule__Lower__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2955:1: ( ( ( rule__Lower__Bound_lowerAssignment_1 ) ) )
            // InternalAdeptness.g:2956:1: ( ( rule__Lower__Bound_lowerAssignment_1 ) )
            {
            // InternalAdeptness.g:2956:1: ( ( rule__Lower__Bound_lowerAssignment_1 ) )
            // InternalAdeptness.g:2957:2: ( rule__Lower__Bound_lowerAssignment_1 )
            {
             before(grammarAccess.getLowerAccess().getBound_lowerAssignment_1()); 
            // InternalAdeptness.g:2958:2: ( rule__Lower__Bound_lowerAssignment_1 )
            // InternalAdeptness.g:2958:3: rule__Lower__Bound_lowerAssignment_1
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:2967:1: rule__Range__Group__0 : rule__Range__Group__0__Impl rule__Range__Group__1 ;
    public final void rule__Range__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2971:1: ( rule__Range__Group__0__Impl rule__Range__Group__1 )
            // InternalAdeptness.g:2972:2: rule__Range__Group__0__Impl rule__Range__Group__1
            {
            pushFollow(FOLLOW_15);
    ...
    // InternalAdeptness.g:2979:1: rule__Range__Group__0__Impl : ( 'is in range between' ) ;
    public final void rule__Range__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2983:1: ( ( 'is in range between' ) )
            // InternalAdeptness.g:2984:1: ( 'is in range between' )
            {
            // InternalAdeptness.g:2984:1: ( 'is in range between' )
            // InternalAdeptness.g:2985:2: 'is in range between'
            {
    ...
    // InternalAdeptness.g:2994:1: rule__Range__Group__1 : rule__Range__Group__1__Impl rule__Range__Group__2 ;
    public final void rule__Range__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:2998:1: ( rule__Range__Group__1__Impl rule__Range__Group__2 )
            // InternalAdeptness.g:2999:2: rule__Range__Group__1__Impl rule__Range__Group__2
            {
    ...
    // InternalAdeptness.g:3006:1: rule__Range__Group__1__Impl : ( ( rule__Range__Bound_lowerAssignment_1 ) ) ;
    public final void rule__Range__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3010:1: ( ( ( rule__Range__Bound_lowerAssignment_1 ) ) )
            // InternalAdeptness.g:3011:1: ( ( rule__Range__Bound_lowerAssignment_1 ) )
            {
            // InternalAdeptness.g:3011:1: ( ( rule__Range__Bound_lowerAssignment_1 ) )
            // InternalAdeptness.g:3012:2: ( rule__Range__Bound_lowerAssignment_1 )
            {
             before(grammarAccess.getRangeAccess().getBound_lowerAssignment_1()); 
            // InternalAdeptness.g:3013:2: ( rule__Range__Bound_lowerAssignment_1 )
            // InternalAdeptness.g:3013:3: rule__Range__Bound_lowerAssignment_1
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:3021:1: rule__Range__Group__2 : rule__Range__Group__2__Impl rule__Range__Group__3 ;
    public final void rule__Range__Group__2() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3025:1: ( rule__Range__Group__2__Impl rule__Range__Group__3 )
            // InternalAdeptness.g:3026:2: rule__Range__Group__2__Impl rule__Range__Group__3
            {
            pushFollow(FOLLOW_15);
    ...
    // InternalAdeptness.g:3033:1: rule__Range__Group__2__Impl : ( 'and' ) ;
    public final void rule__Range__Group__2__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3037:1: ( ( 'and' ) )
            // InternalAdeptness.g:3038:1: ( 'and' )
            {
            // InternalAdeptness.g:3038:1: ( 'and' )
            // InternalAdeptness.g:3039:2: 'and'
            {
    ...
    // InternalAdeptness.g:3048:1: rule__Range__Group__3 : rule__Range__Group__3__Impl ;
    public final void rule__Range__Group__3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3052:1: ( rule__Range__Group__3__Impl )
            // InternalAdeptness.g:3053:2: rule__Range__Group__3__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:3059:1: rule__Range__Group__3__Impl : ( ( rule__Range__Bound_uppAssignment_3 ) ) ;
    public final void rule__Range__Group__3__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3063:1: ( ( ( rule__Range__Bound_uppAssignment_3 ) ) )
            // InternalAdeptness.g:3064:1: ( ( rule__Range__Bound_uppAssignment_3 ) )
            {
            // InternalAdeptness.g:3064:1: ( ( rule__Range__Bound_uppAssignment_3 ) )
            // InternalAdeptness.g:3065:2: ( rule__Range__Bound_uppAssignment_3 )
            {
             before(grammarAccess.getRangeAccess().getBound_uppAssignment_3()); 
            // InternalAdeptness.g:3066:2: ( rule__Range__Bound_uppAssignment_3 )
            // InternalAdeptness.g:3066:3: rule__Range__Bound_uppAssignment_3
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:3075:1: rule__Gap__Group__0 : rule__Gap__Group__0__Impl rule__Gap__Group__1 ;
    public final void rule__Gap__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3079:1: ( rule__Gap__Group__0__Impl rule__Gap__Group__1 )
            // InternalAdeptness.g:3080:2: rule__Gap__Group__0__Impl rule__Gap__Group__1
            {
            pushFollow(FOLLOW_15);
    ...
    // InternalAdeptness.g:3087:1: rule__Gap__Group__0__Impl : ( 'not in range between' ) ;
    public final void rule__Gap__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3091:1: ( ( 'not in range between' ) )
            // InternalAdeptness.g:3092:1: ( 'not in range between' )
            {
            // InternalAdeptness.g:3092:1: ( 'not in range between' )
            // InternalAdeptness.g:3093:2: 'not in range between'
            {
    ...
    // InternalAdeptness.g:3102:1: rule__Gap__Group__1 : rule__Gap__Group__1__Impl rule__Gap__Group__2 ;
    public final void rule__Gap__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3106:1: ( rule__Gap__Group__1__Impl rule__Gap__Group__2 )
            // InternalAdeptness.g:3107:2: rule__Gap__Group__1__Impl rule__Gap__Group__2
            {
            pushFollow(FOLLOW_35);
    ...
    // InternalAdeptness.g:3114:1: rule__Gap__Group__1__Impl : ( ( rule__Gap__Bound_lowerAssignment_1 ) ) ;
    public final void rule__Gap__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3118:1: ( ( ( rule__Gap__Bound_lowerAssignment_1 ) ) )
            // InternalAdeptness.g:3119:1: ( ( rule__Gap__Bound_lowerAssignment_1 ) )
            {
            // InternalAdeptness.g:3119:1: ( ( rule__Gap__Bound_lowerAssignment_1 ) )
            // InternalAdeptness.g:3120:2: ( rule__Gap__Bound_lowerAssignment_1 )
            {
             before(grammarAccess.getGapAccess().getBound_lowerAssignment_1()); 
            // InternalAdeptness.g:3121:2: ( rule__Gap__Bound_lowerAssignment_1 )
            // InternalAdeptness.g:3121:3: rule__Gap__Bound_lowerAssignment_1
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:3129:1: rule__Gap__Group__2 : rule__Gap__Group__2__Impl rule__Gap__Group__3 ;
    public final void rule__Gap__Group__2() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3133:1: ( rule__Gap__Group__2__Impl rule__Gap__Group__3 )
            // InternalAdeptness.g:3134:2: rule__Gap__Group__2__Impl rule__Gap__Group__3
            {
            pushFollow(FOLLOW_15);
    ...
    // InternalAdeptness.g:3141:1: rule__Gap__Group__2__Impl : ( 'and' ) ;
    public final void rule__Gap__Group__2__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3145:1: ( ( 'and' ) )
            // InternalAdeptness.g:3146:1: ( 'and' )
            {
            // InternalAdeptness.g:3146:1: ( 'and' )
            // InternalAdeptness.g:3147:2: 'and'
            {
    ...
    // InternalAdeptness.g:3156:1: rule__Gap__Group__3 : rule__Gap__Group__3__Impl ;
    public final void rule__Gap__Group__3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3160:1: ( rule__Gap__Group__3__Impl )
            // InternalAdeptness.g:3161:2: rule__Gap__Group__3__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:3167:1: rule__Gap__Group__3__Impl : ( ( rule__Gap__Bound_uppAssignment_3 ) ) ;
    public final void rule__Gap__Group__3__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3171:1: ( ( ( rule__Gap__Bound_uppAssignment_3 ) ) )
            // InternalAdeptness.g:3172:1: ( ( rule__Gap__Bound_uppAssignment_3 ) )
            {
            // InternalAdeptness.g:3172:1: ( ( rule__Gap__Bound_uppAssignment_3 ) )
            // InternalAdeptness.g:3173:2: ( rule__Gap__Bound_uppAssignment_3 )
            {
             before(grammarAccess.getGapAccess().getBound_uppAssignment_3()); 
            // InternalAdeptness.g:3174:2: ( rule__Gap__Bound_uppAssignment_3 )
            // InternalAdeptness.g:3174:3: rule__Gap__Bound_uppAssignment_3
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:3183:1: rule__D__Group__0 : rule__D__Group__0__Impl rule__D__Group__1 ;
    public final void rule__D__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3187:1: ( rule__D__Group__0__Impl rule__D__Group__1 )
            // InternalAdeptness.g:3188:2: rule__D__Group__0__Impl rule__D__Group__1
            {
            pushFollow(FOLLOW_15);
    ...
    // InternalAdeptness.g:3195:1: rule__D__Group__0__Impl : ( ( '-' )? ) ;
    public final void rule__D__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3199:1: ( ( ( '-' )? ) )
            // InternalAdeptness.g:3200:1: ( ( '-' )? )
            {
            // InternalAdeptness.g:3200:1: ( ( '-' )? )
            // InternalAdeptness.g:3201:2: ( '-' )?
            {
             before(grammarAccess.getDAccess().getHyphenMinusKeyword_0()); 
            // InternalAdeptness.g:3202:2: ( '-' )?
            int alt16=2;
    ...
    // InternalAdeptness.g:3210:1: rule__D__Group__1 : rule__D__Group__1__Impl rule__D__Group__2 ;
    public final void rule__D__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3214:1: ( rule__D__Group__1__Impl rule__D__Group__2 )
            // InternalAdeptness.g:3215:2: rule__D__Group__1__Impl rule__D__Group__2
            {
            pushFollow(FOLLOW_6);
    ...
    // InternalAdeptness.g:3222:1: rule__D__Group__1__Impl : ( RULE_INT ) ;
    public final void rule__D__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3226:1: ( ( RULE_INT ) )
            // InternalAdeptness.g:3227:1: ( RULE_INT )
            {
            // InternalAdeptness.g:3227:1: ( RULE_INT )
            // InternalAdeptness.g:3228:2: RULE_INT
            {
    ...
    // InternalAdeptness.g:3237:1: rule__D__Group__2 : rule__D__Group__2__Impl ;
    public final void rule__D__Group__2() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3241:1: ( rule__D__Group__2__Impl )
            // InternalAdeptness.g:3242:2: rule__D__Group__2__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:3248:1: rule__D__Group__2__Impl : ( ( rule__D__Group_2__0 )? ) ;
    public final void rule__D__Group__2__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3252:1: ( ( ( rule__D__Group_2__0 )? ) )
            // InternalAdeptness.g:3253:1: ( ( rule__D__Group_2__0 )? )
            {
            // InternalAdeptness.g:3253:1: ( ( rule__D__Group_2__0 )? )
            // InternalAdeptness.g:3254:2: ( rule__D__Group_2__0 )?
            {
             before(grammarAccess.getDAccess().getGroup_2()); 
            // InternalAdeptness.g:3255:2: ( rule__D__Group_2__0 )?
            int alt17=2;
            ...
            switch (alt17) {
                case 1 :
                    // InternalAdeptness.g:3255:3: rule__D__Group_2__0
                    {
                    pushFollow(FOLLOW_2);
                    rule__D__Group_2__0();
    ...
    // InternalAdeptness.g:3264:1: rule__D__Group_2__0 : rule__D__Group_2__0__Impl rule__D__Group_2__1 ;
    public final void rule__D__Group_2__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3268:1: ( rule__D__Group_2__0__Impl rule__D__Group_2__1 )
            // InternalAdeptness.g:3269:2: rule__D__Group_2__0__Impl rule__D__Group_2__1
            {
            pushFollow(FOLLOW_32);
    ...
    // InternalAdeptness.g:3276:1: rule__D__Group_2__0__Impl : ( '.' ) ;
    public final void rule__D__Group_2__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3280:1: ( ( '.' ) )
            // InternalAdeptness.g:3281:1: ( '.' )
            {
            // InternalAdeptness.g:3281:1: ( '.' )
            // InternalAdeptness.g:3282:2: '.'
            {
    ...
    // InternalAdeptness.g:3291:1: rule__D__Group_2__1 : rule__D__Group_2__1__Impl ;
    public final void rule__D__Group_2__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3295:1: ( rule__D__Group_2__1__Impl )
            // InternalAdeptness.g:3296:2: rule__D__Group_2__1__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:3302:1: rule__D__Group_2__1__Impl : ( RULE_INT ) ;
    public final void rule__D__Group_2__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3306:1: ( ( RULE_INT ) )
            // InternalAdeptness.g:3307:1: ( RULE_INT )
            {
            // InternalAdeptness.g:3307:1: ( RULE_INT )
            // InternalAdeptness.g:3308:2: RULE_INT
            {
    ...
    // InternalAdeptness.g:3318:1: rule__DataType__Group__0 : rule__DataType__Group__0__Impl rule__DataType__Group__1 ;
    public final void rule__DataType__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3322:1: ( rule__DataType__Group__0__Impl rule__DataType__Group__1 )
            // InternalAdeptness.g:3323:2: rule__DataType__Group__0__Impl rule__DataType__Group__1
            {
            pushFollow(FOLLOW_4);
    ...
    // InternalAdeptness.g:3330:1: rule__DataType__Group__0__Impl : ( 'datatype' ) ;
    public final void rule__DataType__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3334:1: ( ( 'datatype' ) )
            // InternalAdeptness.g:3335:1: ( 'datatype' )
            {
            // InternalAdeptness.g:3335:1: ( 'datatype' )
            // InternalAdeptness.g:3336:2: 'datatype'
            {
    ...
    // InternalAdeptness.g:3345:1: rule__DataType__Group__1 : rule__DataType__Group__1__Impl ;
    public final void rule__DataType__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3349:1: ( rule__DataType__Group__1__Impl )
            // InternalAdeptness.g:3350:2: rule__DataType__Group__1__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:3356:1: rule__DataType__Group__1__Impl : ( ( rule__DataType__NameAssignment_1 ) ) ;
    public final void rule__DataType__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3360:1: ( ( ( rule__DataType__NameAssignment_1 ) ) )
            // InternalAdeptness.g:3361:1: ( ( rule__DataType__NameAssignment_1 ) )
            {
            // InternalAdeptness.g:3361:1: ( ( rule__DataType__NameAssignment_1 ) )
            // InternalAdeptness.g:3362:2: ( rule__DataType__NameAssignment_1 )
            {
             before(grammarAccess.getDataTypeAccess().getNameAssignment_1()); 
            // InternalAdeptness.g:3363:2: ( rule__DataType__NameAssignment_1 )
            // InternalAdeptness.g:3363:3: rule__DataType__NameAssignment_1
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:3372:1: rule__PackageDeclaration__Group__0 : rule__PackageDeclaration__Group__0__Impl rule__PackageDeclaration__Group__1 ;
    public final void rule__PackageDeclaration__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3376:1: ( rule__PackageDeclaration__Group__0__Impl rule__PackageDeclaration__Group__1 )
            // InternalAdeptness.g:3377:2: rule__PackageDeclaration__Group__0__Impl rule__PackageDeclaration__Group__1
            {
            pushFollow(FOLLOW_4);
    ...
    // InternalAdeptness.g:3384:1: rule__PackageDeclaration__Group__0__Impl : ( 'package' ) ;
    public final void rule__PackageDeclaration__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3388:1: ( ( 'package' ) )
            // InternalAdeptness.g:3389:1: ( 'package' )
            {
            // InternalAdeptness.g:3389:1: ( 'package' )
            // InternalAdeptness.g:3390:2: 'package'
            {
    ...
    // InternalAdeptness.g:3399:1: rule__PackageDeclaration__Group__1 : rule__PackageDeclaration__Group__1__Impl rule__PackageDeclaration__Group__2 ;
    public final void rule__PackageDeclaration__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3403:1: ( rule__PackageDeclaration__Group__1__Impl rule__PackageDeclaration__Group__2 )
            // InternalAdeptness.g:3404:2: rule__PackageDeclaration__Group__1__Impl rule__PackageDeclaration__Group__2
            {
    ...
    // InternalAdeptness.g:3411:1: rule__PackageDeclaration__Group__1__Impl : ( ( rule__PackageDeclaration__NameAssignment_1 ) ) ;
    public final void rule__PackageDeclaration__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3415:1: ( ( ( rule__PackageDeclaration__NameAssignment_1 ) ) )
            // InternalAdeptness.g:3416:1: ( ( rule__PackageDeclaration__NameAssignment_1 ) )
            {
            // InternalAdeptness.g:3416:1: ( ( rule__PackageDeclaration__NameAssignment_1 ) )
            // InternalAdeptness.g:3417:2: ( rule__PackageDeclaration__NameAssignment_1 )
            {
             before(grammarAccess.getPackageDeclarationAccess().getNameAssignment_1()); 
            // InternalAdeptness.g:3418:2: ( rule__PackageDeclaration__NameAssignment_1 )
            // InternalAdeptness.g:3418:3: rule__PackageDeclaration__NameAssignment_1
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:3426:1: rule__PackageDeclaration__Group__2 : rule__PackageDeclaration__Group__2__Impl rule__PackageDeclaration__Group__3 ;
    public final void rule__PackageDeclaration__Group__2() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3430:1: ( rule__PackageDeclaration__Group__2__Impl rule__PackageDeclaration__Group__3 )
            // InternalAdeptness.g:3431:2: rule__PackageDeclaration__Group__2__Impl rule__PackageDeclaration__Group__3
            {
    ...
    // InternalAdeptness.g:3438:1: rule__PackageDeclaration__Group__2__Impl : ( '{' ) ;
    ...
    // InternalAdeptness.g:3453:1: rule__PackageDeclaration__Group__3 : rule__PackageDeclaration__Group__3__Impl rule__PackageDeclaration__Group__4 ;
    public final void rule__PackageDeclaration__Group__3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3457:1: ( rule__PackageDeclaration__Group__3__Impl rule__PackageDeclaration__Group__4 )
            // InternalAdeptness.g:3458:2: rule__PackageDeclaration__Group__3__Impl rule__PackageDeclaration__Group__4
            {
            pushFollow(FOLLOW_37);
    ...
    // InternalAdeptness.g:3465:1: rule__PackageDeclaration__Group__3__Impl : ( ( rule__PackageDeclaration__ElementsAssignment_3 )* ) ;
    public final void rule__PackageDeclaration__Group__3__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3469:1: ( ( ( rule__PackageDeclaration__ElementsAssignment_3 )* ) )
            // InternalAdeptness.g:3470:1: ( ( rule__PackageDeclaration__ElementsAssignment_3 )* )
            {
            // InternalAdeptness.g:3470:1: ( ( rule__PackageDeclaration__ElementsAssignment_3 )* )
            // InternalAdeptness.g:3471:2: ( rule__PackageDeclaration__ElementsAssignment_3 )*
            {
             before(grammarAccess.getPackageDeclarationAccess().getElementsAssignment_3()); 
            // InternalAdeptness.g:3472:2: ( rule__PackageDeclaration__ElementsAssignment_3 )*
            loop18:
            do {
                int alt18=2;
                int LA18_0 = input.LA(1);

                if ( (LA18_0==16||LA18_0==19||LA18_0==26||(LA18_0>=45 && LA18_0<=46)) ) {
                    alt18=1;
                }
                ...
                switch (alt18) {
            	case 1 :
            	    // InternalAdeptness.g:3472:3: rule__PackageDeclaration__ElementsAssignment_3
            	    {
            	    pushFollow(FOLLOW_3);
    ...
    // InternalAdeptness.g:3480:1: rule__PackageDeclaration__Group__4 : rule__PackageDeclaration__Group__4__Impl ;
    public final void rule__PackageDeclaration__Group__4() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3484:1: ( rule__PackageDeclaration__Group__4__Impl )
            // InternalAdeptness.g:3485:2: rule__PackageDeclaration__Group__4__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:3491:1: rule__PackageDeclaration__Group__4__Impl : ( '}' ) ;
    public final void rule__PackageDeclaration__Group__4__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3495:1: ( ( '}' ) )
            // InternalAdeptness.g:3496:1: ( '}' )
            {
            // InternalAdeptness.g:3496:1: ( '}' )
            // InternalAdeptness.g:3497:2: '}'
            {
    ...
    // InternalAdeptness.g:3507:1: rule__Adeptness__ElementsAssignment : ( ruleAbstractElement ) ;
    public final void rule__Adeptness__ElementsAssignment() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3511:1: ( ( ruleAbstractElement ) )
            // InternalAdeptness.g:3512:2: ( ruleAbstractElement )
            {
            // InternalAdeptness.g:3512:2: ( ruleAbstractElement )
            // InternalAdeptness.g:3513:3: ruleAbstractElement
            {
    ...
    // InternalAdeptness.g:3522:1: rule__Import__ImportedNamespaceAssignment_1 : ( ruleQualifiedNameWithWildcard ) ;
    public final void rule__Import__ImportedNamespaceAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3526:1: ( ( ruleQualifiedNameWithWildcard ) )
            // InternalAdeptness.g:3527:2: ( ruleQualifiedNameWithWildcard )
            {
            // InternalAdeptness.g:3527:2: ( ruleQualifiedNameWithWildcard )
            // InternalAdeptness.g:3528:3: ruleQualifiedNameWithWildcard
            {
    ...
    // InternalAdeptness.g:3537:1: rule__MonitoringFile__NameAssignment_1 : ( RULE_ID ) ;
    public final void rule__MonitoringFile__NameAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3541:1: ( ( RULE_ID ) )
            // InternalAdeptness.g:3542:2: ( RULE_ID )
            {
            // InternalAdeptness.g:3542:2: ( RULE_ID )
            // InternalAdeptness.g:3543:3: RULE_ID
            {
    ...
    // InternalAdeptness.g:3552:1: rule__MonitoringFile__MonitoringPlanAssignment_3 : ( ruleMonitoringPlan ) ;
    public final void rule__MonitoringFile__MonitoringPlanAssignment_3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3556:1: ( ( ruleMonitoringPlan ) )
            // InternalAdeptness.g:3557:2: ( ruleMonitoringPlan )
            {
            // InternalAdeptness.g:3557:2: ( ruleMonitoringPlan )
            // InternalAdeptness.g:3558:3: ruleMonitoringPlan
            {
    ...
    // InternalAdeptness.g:3567:1: rule__MonitoringPlan__MonitoringVariablesAssignment : ( ruleMonitoringVariable ) ;
    public final void rule__MonitoringPlan__MonitoringVariablesAssignment() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3571:1: ( ( ruleMonitoringVariable ) )
            // InternalAdeptness.g:3572:2: ( ruleMonitoringVariable )
            {
            // InternalAdeptness.g:3572:2: ( ruleMonitoringVariable )
            // InternalAdeptness.g:3573:3: ruleMonitoringVariable
            {
    ...
    // InternalAdeptness.g:3582:1: rule__MonitoringVariable__NameAssignment_1 : ( RULE_ID ) ;
    public final void rule__MonitoringVariable__NameAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3586:1: ( ( RULE_ID ) )
            // InternalAdeptness.g:3587:2: ( RULE_ID )
            {
            // InternalAdeptness.g:3587:2: ( RULE_ID )
            // InternalAdeptness.g:3588:3: RULE_ID
            {
    ...
    // InternalAdeptness.g:3597:1: rule__MonitoringVariable__MonitoringVariableDatatypeAssignment_5 : ( ruleSig_type ) ;
    public final void rule__MonitoringVariable__MonitoringVariableDatatypeAssignment_5() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3601:1: ( ( ruleSig_type ) )
            // InternalAdeptness.g:3602:2: ( ruleSig_type )
            {
            // InternalAdeptness.g:3602:2: ( ruleSig_type )
            // InternalAdeptness.g:3603:3: ruleSig_type
            {
    ...
    // $ANTLR start "rule__MonitoringVariable__MaxAssignment_6_1"
    // InternalAdeptness.g:3612:1: rule__MonitoringVariable__MaxAssignment_6_1 : ( ruleDOUBLE ) ;
    public final void rule__MonitoringVariable__MaxAssignment_6_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3616:1: ( ( ruleDOUBLE ) )
            // InternalAdeptness.g:3617:2: ( ruleDOUBLE )
            {
            // InternalAdeptness.g:3617:2: ( ruleDOUBLE )
            // InternalAdeptness.g:3618:3: ruleDOUBLE
            {
             before(grammarAccess.getMonitoringVariableAccess().getMaxDOUBLEParserRuleCall_6_1_0()); 
            pushFollow(FOLLOW_2);
            ruleDOUBLE();

            state._fsp--;

             after(grammarAccess.getMonitoringVariableAccess().getMaxDOUBLEParserRuleCall_6_1_0()); 
    ...
    // $ANTLR end "rule__MonitoringVariable__MaxAssignment_6_1"


    // $ANTLR start "rule__MonitoringVariable__MinAssignment_6_3"
    // InternalAdeptness.g:3627:1: rule__MonitoringVariable__MinAssignment_6_3 : ( ruleDOUBLE ) ;
    public final void rule__MonitoringVariable__MinAssignment_6_3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3631:1: ( ( ruleDOUBLE ) )
            // InternalAdeptness.g:3632:2: ( ruleDOUBLE )
            {
            // InternalAdeptness.g:3632:2: ( ruleDOUBLE )
            // InternalAdeptness.g:3633:3: ruleDOUBLE
            {
             before(grammarAccess.getMonitoringVariableAccess().getMinDOUBLEParserRuleCall_6_3_0()); 
            pushFollow(FOLLOW_2);
            ruleDOUBLE();

            state._fsp--;

             after(grammarAccess.getMonitoringVariableAccess().getMinDOUBLEParserRuleCall_6_3_0()); 
    ...
    // $ANTLR end "rule__MonitoringVariable__MinAssignment_6_3"


    // $ANTLR start "rule__Sig_type__Sig_typeAssignment"
    // InternalAdeptness.g:3642:1: rule__Sig_type__Sig_typeAssignment : ( ( rule__Sig_type__Sig_typeAlternatives_0 ) ) ;
    public final void rule__Sig_type__Sig_typeAssignment() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3646:1: ( ( ( rule__Sig_type__Sig_typeAlternatives_0 ) ) )
            // InternalAdeptness.g:3647:2: ( ( rule__Sig_type__Sig_typeAlternatives_0 ) )
            {
            // InternalAdeptness.g:3647:2: ( ( rule__Sig_type__Sig_typeAlternatives_0 ) )
            // InternalAdeptness.g:3648:3: ( rule__Sig_type__Sig_typeAlternatives_0 )
            {
             before(grammarAccess.getSig_typeAccess().getSig_typeAlternatives_0()); 
            // InternalAdeptness.g:3649:3: ( rule__Sig_type__Sig_typeAlternatives_0 )
            // InternalAdeptness.g:3649:4: rule__Sig_type__Sig_typeAlternatives_0
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalAdeptness.g:3657:1: rule__Signal__NameAssignment_1 : ( RULE_ID ) ;
    public final void rule__Signal__NameAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3661:1: ( ( RULE_ID ) )
            // InternalAdeptness.g:3662:2: ( RULE_ID )
            {
            // InternalAdeptness.g:3662:2: ( RULE_ID )
            // InternalAdeptness.g:3663:3: RULE_ID
            {
    ...
    // InternalAdeptness.g:3672:1: rule__Signal__OracleAssignment_3 : ( ruleOracle ) ;
    public final void rule__Signal__OracleAssignment_3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3676:1: ( ( ruleOracle ) )
            // InternalAdeptness.g:3677:2: ( ruleOracle )
            {
            // InternalAdeptness.g:3677:2: ( ruleOracle )
            // InternalAdeptness.g:3678:3: ruleOracle
            {
    ...
    // InternalAdeptness.g:3687:1: rule__Oracle__NameAssignment_1 : ( RULE_ID ) ;
    public final void rule__Oracle__NameAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3691:1: ( ( RULE_ID ) )
            // InternalAdeptness.g:3692:2: ( RULE_ID )
            {
            // InternalAdeptness.g:3692:2: ( RULE_ID )
            // InternalAdeptness.g:3693:3: RULE_ID
            {
    ...
    // InternalAdeptness.g:3702:1: rule__Oracle__CheckAssignment_3 : ( ruleChecks ) ;
    public final void rule__Oracle__CheckAssignment_3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3706:1: ( ( ruleChecks ) )
            // InternalAdeptness.g:3707:2: ( ruleChecks )
            {
            // InternalAdeptness.g:3707:2: ( ruleChecks )
            // InternalAdeptness.g:3708:3: ruleChecks
            {
    ...
    // InternalAdeptness.g:3717:1: rule__Checks__NameAssignment_1 : ( RULE_STRING ) ;
    public final void rule__Checks__NameAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3721:1: ( ( RULE_STRING ) )
            // InternalAdeptness.g:3722:2: ( RULE_STRING )
            {
            // InternalAdeptness.g:3722:2: ( RULE_STRING )
            // InternalAdeptness.g:3723:3: RULE_STRING
            {
    ...
    // InternalAdeptness.g:3732:1: rule__Checks__ReferenceAssignment_2 : ( ruleReference ) ;
    public final void rule__Checks__ReferenceAssignment_2() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3736:1: ( ( ruleReference ) )
            // InternalAdeptness.g:3737:2: ( ruleReference )
            {
            // InternalAdeptness.g:3737:2: ( ruleReference )
            // InternalAdeptness.g:3738:3: ruleReference
            {
    ...
    // InternalAdeptness.g:3747:1: rule__Checks__FailReasonAssignment_3 : ( ruleFailReason ) ;
    public final void rule__Checks__FailReasonAssignment_3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3751:1: ( ( ruleFailReason ) )
            // InternalAdeptness.g:3752:2: ( ruleFailReason )
            {
            // InternalAdeptness.g:3752:2: ( ruleFailReason )
            // InternalAdeptness.g:3753:3: ruleFailReason
            {
    ...
    // InternalAdeptness.g:3762:1: rule__Checks__DescriptionAssignment_4 : ( ruleDescription ) ;
    public final void rule__Checks__DescriptionAssignment_4() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3766:1: ( ( ruleDescription ) )
            // InternalAdeptness.g:3767:2: ( ruleDescription )
            {
            // InternalAdeptness.g:3767:2: ( ruleDescription )
            // InternalAdeptness.g:3768:3: ruleDescription
            {
    ...
    // InternalAdeptness.g:3777:1: rule__Description__ValueAssignment_1 : ( RULE_STRING ) ;
    public final void rule__Description__ValueAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3781:1: ( ( RULE_STRING ) )
            // InternalAdeptness.g:3782:2: ( RULE_STRING )
            {
            // InternalAdeptness.g:3782:2: ( RULE_STRING )
            // InternalAdeptness.g:3783:3: RULE_STRING
            {
    ...
    // InternalAdeptness.g:3792:1: rule__FailReason__ReasonAssignment_1 : ( ruleReason ) ;
    public final void rule__FailReason__ReasonAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3796:1: ( ( ruleReason ) )
            // InternalAdeptness.g:3797:2: ( ruleReason )
            {
            // InternalAdeptness.g:3797:2: ( ruleReason )
            // InternalAdeptness.g:3798:3: ruleReason
            {
    ...
    // InternalAdeptness.g:3807:1: rule__Reason__HighPeakAssignment_0_0 : ( ruleHighPeak ) ;
    public final void rule__Reason__HighPeakAssignment_0_0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3811:1: ( ( ruleHighPeak ) )
            // InternalAdeptness.g:3812:2: ( ruleHighPeak )
            {
            // InternalAdeptness.g:3812:2: ( ruleHighPeak )
            // InternalAdeptness.g:3813:3: ruleHighPeak
            {
    ...
    // InternalAdeptness.g:3822:1: rule__Reason__HighTimeAssignment_0_1 : ( ruleHighTime ) ;
    public final void rule__Reason__HighTimeAssignment_0_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3826:1: ( ( ruleHighTime ) )
            // InternalAdeptness.g:3827:2: ( ruleHighTime )
            {
            // InternalAdeptness.g:3827:2: ( ruleHighTime )
            // InternalAdeptness.g:3828:3: ruleHighTime
            {
    ...
    // InternalAdeptness.g:3837:1: rule__Reason__ConstDegAssignment_0_2 : ( ruleConstDeg ) ;
    public final void rule__Reason__ConstDegAssignment_0_2() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3841:1: ( ( ruleConstDeg ) )
            // InternalAdeptness.g:3842:2: ( ruleConstDeg )
            {
            // InternalAdeptness.g:3842:2: ( ruleConstDeg )
            // InternalAdeptness.g:3843:3: ruleConstDeg
            {
    ...
    // InternalAdeptness.g:3852:1: rule__Reason__XPeaksAssignment_0_3 : ( ruleXPeaks ) ;
    public final void rule__Reason__XPeaksAssignment_0_3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3856:1: ( ( ruleXPeaks ) )
            // InternalAdeptness.g:3857:2: ( ruleXPeaks )
            {
            // InternalAdeptness.g:3857:2: ( ruleXPeaks )
            // InternalAdeptness.g:3858:3: ruleXPeaks
            {
    ...
    // InternalAdeptness.g:3867:1: rule__XPeaks__CantAssignment_1 : ( ruleDOUBLE ) ;
    public final void rule__XPeaks__CantAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3871:1: ( ( ruleDOUBLE ) )
            // InternalAdeptness.g:3872:2: ( ruleDOUBLE )
            {
            // InternalAdeptness.g:3872:2: ( ruleDOUBLE )
            // InternalAdeptness.g:3873:3: ruleDOUBLE
            {
    ...
    // InternalAdeptness.g:3882:1: rule__XPeaks__NPeaksAssignment_3 : ( ruleDOUBLE ) ;
    public final void rule__XPeaks__NPeaksAssignment_3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3886:1: ( ( ruleDOUBLE ) )
            // InternalAdeptness.g:3887:2: ( ruleDOUBLE )
            {
            // InternalAdeptness.g:3887:2: ( ruleDOUBLE )
            // InternalAdeptness.g:3888:3: ruleDOUBLE
            {
    ...
    // InternalAdeptness.g:3897:1: rule__XPeaks__TimeAssignment_5 : ( RULE_INT ) ;
    public final void rule__XPeaks__TimeAssignment_5() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3901:1: ( ( RULE_INT ) )
            // InternalAdeptness.g:3902:2: ( RULE_INT )
            {
            // InternalAdeptness.g:3902:2: ( RULE_INT )
            // InternalAdeptness.g:3903:3: RULE_INT
            {
    ...
    // InternalAdeptness.g:3912:1: rule__XPeaks__UnitAssignment_6 : ( ruleTimeType ) ;
    public final void rule__XPeaks__UnitAssignment_6() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3916:1: ( ( ruleTimeType ) )
            // InternalAdeptness.g:3917:2: ( ruleTimeType )
            {
            // InternalAdeptness.g:3917:2: ( ruleTimeType )
            // InternalAdeptness.g:3918:3: ruleTimeType
            {
    ...
    // InternalAdeptness.g:3927:1: rule__ConstDeg__CantAssignment_1 : ( ruleDOUBLE ) ;
    public final void rule__ConstDeg__CantAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3931:1: ( ( ruleDOUBLE ) )
            // InternalAdeptness.g:3932:2: ( ruleDOUBLE )
            {
            // InternalAdeptness.g:3932:2: ( ruleDOUBLE )
            // InternalAdeptness.g:3933:3: ruleDOUBLE
            {
    ...
    // InternalAdeptness.g:3942:1: rule__HighTime__CantAssignment_1 : ( ruleDOUBLE ) ;
    public final void rule__HighTime__CantAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3946:1: ( ( ruleDOUBLE ) )
            // InternalAdeptness.g:3947:2: ( ruleDOUBLE )
            {
            // InternalAdeptness.g:3947:2: ( ruleDOUBLE )
            // InternalAdeptness.g:3948:3: ruleDOUBLE
            {
    ...
    // InternalAdeptness.g:3957:1: rule__HighTime__TimeAssignment_3 : ( ruleDOUBLE ) ;
    public final void rule__HighTime__TimeAssignment_3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3961:1: ( ( ruleDOUBLE ) )
            // InternalAdeptness.g:3962:2: ( ruleDOUBLE )
            {
            // InternalAdeptness.g:3962:2: ( ruleDOUBLE )
            // InternalAdeptness.g:3963:3: ruleDOUBLE
            {
    ...
    // InternalAdeptness.g:3972:1: rule__HighTime__UnitAssignment_4 : ( ruleTimeType ) ;
    public final void rule__HighTime__UnitAssignment_4() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3976:1: ( ( ruleTimeType ) )
            // InternalAdeptness.g:3977:2: ( ruleTimeType )
            {
            // InternalAdeptness.g:3977:2: ( ruleTimeType )
            // InternalAdeptness.g:3978:3: ruleTimeType
            {
    ...
    // InternalAdeptness.g:3987:1: rule__HighPeak__CantAssignment_1 : ( ruleDOUBLE ) ;
    public final void rule__HighPeak__CantAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:3991:1: ( ( ruleDOUBLE ) )
            // InternalAdeptness.g:3992:2: ( ruleDOUBLE )
            {
            // InternalAdeptness.g:3992:2: ( ruleDOUBLE )
            // InternalAdeptness.g:3993:3: ruleDOUBLE
            {
    ...
    // InternalAdeptness.g:4002:1: rule__Reference__UpperAssignment_0_0 : ( ruleUpper ) ;
    public final void rule__Reference__UpperAssignment_0_0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:4006:1: ( ( ruleUpper ) )
            // InternalAdeptness.g:4007:2: ( ruleUpper )
            {
            // InternalAdeptness.g:4007:2: ( ruleUpper )
            // InternalAdeptness.g:4008:3: ruleUpper
            {
    ...
    // InternalAdeptness.g:4017:1: rule__Reference__LowerAssignment_0_1 : ( ruleLower ) ;
    public final void rule__Reference__LowerAssignment_0_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:4021:1: ( ( ruleLower ) )
            // InternalAdeptness.g:4022:2: ( ruleLower )
            {
            // InternalAdeptness.g:4022:2: ( ruleLower )
            // InternalAdeptness.g:4023:3: ruleLower
            {
    ...
    // InternalAdeptness.g:4032:1: rule__Reference__RangeAssignment_0_2 : ( ruleRange ) ;
    public final void rule__Reference__RangeAssignment_0_2() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:4036:1: ( ( ruleRange ) )
            // InternalAdeptness.g:4037:2: ( ruleRange )
            {
            // InternalAdeptness.g:4037:2: ( ruleRange )
            // InternalAdeptness.g:4038:3: ruleRange
            {
    ...
    // InternalAdeptness.g:4047:1: rule__Reference__GapAssignment_0_3 : ( ruleGap ) ;
    public final void rule__Reference__GapAssignment_0_3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:4051:1: ( ( ruleGap ) )
            // InternalAdeptness.g:4052:2: ( ruleGap )
            {
            // InternalAdeptness.g:4052:2: ( ruleGap )
            // InternalAdeptness.g:4053:3: ruleGap
            {
    ...
    // InternalAdeptness.g:4062:1: rule__Upper__Bound_uppAssignment_1 : ( ruleBound_up ) ;
    public final void rule__Upper__Bound_uppAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:4066:1: ( ( ruleBound_up ) )
            // InternalAdeptness.g:4067:2: ( ruleBound_up )
            {
            // InternalAdeptness.g:4067:2: ( ruleBound_up )
            // InternalAdeptness.g:4068:3: ruleBound_up
            {
    ...
    // InternalAdeptness.g:4077:1: rule__Lower__Bound_lowerAssignment_1 : ( ruleBound_Down ) ;
    public final void rule__Lower__Bound_lowerAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:4081:1: ( ( ruleBound_Down ) )
            // InternalAdeptness.g:4082:2: ( ruleBound_Down )
            {
            // InternalAdeptness.g:4082:2: ( ruleBound_Down )
            // InternalAdeptness.g:4083:3: ruleBound_Down
            {
    ...
    // InternalAdeptness.g:4092:1: rule__Range__Bound_lowerAssignment_1 : ( ruleBound_Down ) ;
    public final void rule__Range__Bound_lowerAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:4096:1: ( ( ruleBound_Down ) )
            // InternalAdeptness.g:4097:2: ( ruleBound_Down )
            {
            // InternalAdeptness.g:4097:2: ( ruleBound_Down )
            // InternalAdeptness.g:4098:3: ruleBound_Down
            {
    ...
    // InternalAdeptness.g:4107:1: rule__Range__Bound_uppAssignment_3 : ( ruleBound_up ) ;
    public final void rule__Range__Bound_uppAssignment_3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:4111:1: ( ( ruleBound_up ) )
            // InternalAdeptness.g:4112:2: ( ruleBound_up )
            {
            // InternalAdeptness.g:4112:2: ( ruleBound_up )
            // InternalAdeptness.g:4113:3: ruleBound_up
            {
    ...
    // InternalAdeptness.g:4122:1: rule__Gap__Bound_lowerAssignment_1 : ( ruleBound_Down ) ;
    public final void rule__Gap__Bound_lowerAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:4126:1: ( ( ruleBound_Down ) )
            // InternalAdeptness.g:4127:2: ( ruleBound_Down )
            {
            // InternalAdeptness.g:4127:2: ( ruleBound_Down )
            // InternalAdeptness.g:4128:3: ruleBound_Down
            {
    ...
    // InternalAdeptness.g:4137:1: rule__Gap__Bound_uppAssignment_3 : ( ruleBound_up ) ;
    public final void rule__Gap__Bound_uppAssignment_3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:4141:1: ( ( ruleBound_up ) )
            // InternalAdeptness.g:4142:2: ( ruleBound_up )
            {
            // InternalAdeptness.g:4142:2: ( ruleBound_up )
            // InternalAdeptness.g:4143:3: ruleBound_up
            {
    ...
    // InternalAdeptness.g:4152:1: rule__Bound_up__ValueAssignment : ( ruleDOUBLE ) ;
    public final void rule__Bound_up__ValueAssignment() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:4156:1: ( ( ruleDOUBLE ) )
            // InternalAdeptness.g:4157:2: ( ruleDOUBLE )
            {
            // InternalAdeptness.g:4157:2: ( ruleDOUBLE )
            // InternalAdeptness.g:4158:3: ruleDOUBLE
            {
    ...
    // InternalAdeptness.g:4167:1: rule__Bound_Down__ValueAssignment : ( ruleDOUBLE ) ;
    public final void rule__Bound_Down__ValueAssignment() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:4171:1: ( ( ruleDOUBLE ) )
            // InternalAdeptness.g:4172:2: ( ruleDOUBLE )
            {
            // InternalAdeptness.g:4172:2: ( ruleDOUBLE )
            // InternalAdeptness.g:4173:3: ruleDOUBLE
            {
    ...
    // InternalAdeptness.g:4182:1: rule__BOOLEAN__BoolAssignment : ( ruleb ) ;
    public final void rule__BOOLEAN__BoolAssignment() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:4186:1: ( ( ruleb ) )
            // InternalAdeptness.g:4187:2: ( ruleb )
            {
            // InternalAdeptness.g:4187:2: ( ruleb )
            // InternalAdeptness.g:4188:3: ruleb
            {
    ...
    // InternalAdeptness.g:4197:1: rule__DOUBLE__DValAssignment : ( ruled ) ;
    public final void rule__DOUBLE__DValAssignment() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:4201:1: ( ( ruled ) )
            // InternalAdeptness.g:4202:2: ( ruled )
            {
            // InternalAdeptness.g:4202:2: ( ruled )
            // InternalAdeptness.g:4203:3: ruled
            {
    ...
    // InternalAdeptness.g:4212:1: rule__TimeType__TimeAssignment_0 : ( ( 'miliseconds' ) ) ;
    public final void rule__TimeType__TimeAssignment_0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:4216:1: ( ( ( 'miliseconds' ) ) )
            // InternalAdeptness.g:4217:2: ( ( 'miliseconds' ) )
            {
            // InternalAdeptness.g:4217:2: ( ( 'miliseconds' ) )
            // InternalAdeptness.g:4218:3: ( 'miliseconds' )
            {
             before(grammarAccess.getTimeTypeAccess().getTimeMilisecondsKeyword_0_0()); 
            // InternalAdeptness.g:4219:3: ( 'miliseconds' )
            // InternalAdeptness.g:4220:4: 'miliseconds'
            {
             before(grammarAccess.getTimeTypeAccess().getTimeMilisecondsKeyword_0_0()); 
    ...
    // InternalAdeptness.g:4231:1: rule__TimeType__TimeAssignment_1 : ( ( 'seconds' ) ) ;
    public final void rule__TimeType__TimeAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:4235:1: ( ( ( 'seconds' ) ) )
            // InternalAdeptness.g:4236:2: ( ( 'seconds' ) )
            {
            // InternalAdeptness.g:4236:2: ( ( 'seconds' ) )
            // InternalAdeptness.g:4237:3: ( 'seconds' )
            {
             before(grammarAccess.getTimeTypeAccess().getTimeSecondsKeyword_1_0()); 
            // InternalAdeptness.g:4238:3: ( 'seconds' )
            // InternalAdeptness.g:4239:4: 'seconds'
            {
             before(grammarAccess.getTimeTypeAccess().getTimeSecondsKeyword_1_0()); 
    ...
    // InternalAdeptness.g:4250:1: rule__TimeType__TimeAssignment_2 : ( ( 'minutes' ) ) ;
    public final void rule__TimeType__TimeAssignment_2() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:4254:1: ( ( ( 'minutes' ) ) )
            // InternalAdeptness.g:4255:2: ( ( 'minutes' ) )
            {
            // InternalAdeptness.g:4255:2: ( ( 'minutes' ) )
            // InternalAdeptness.g:4256:3: ( 'minutes' )
            {
             before(grammarAccess.getTimeTypeAccess().getTimeMinutesKeyword_2_0()); 
            // InternalAdeptness.g:4257:3: ( 'minutes' )
            // InternalAdeptness.g:4258:4: 'minutes'
            {
             before(grammarAccess.getTimeTypeAccess().getTimeMinutesKeyword_2_0()); 
    ...
    // InternalAdeptness.g:4269:1: rule__TimeType__TimeAssignment_3 : ( ( 'hours' ) ) ;
    public final void rule__TimeType__TimeAssignment_3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:4273:1: ( ( ( 'hours' ) ) )
            // InternalAdeptness.g:4274:2: ( ( 'hours' ) )
            {
            // InternalAdeptness.g:4274:2: ( ( 'hours' ) )
            // InternalAdeptness.g:4275:3: ( 'hours' )
            {
             before(grammarAccess.getTimeTypeAccess().getTimeHoursKeyword_3_0()); 
            // InternalAdeptness.g:4276:3: ( 'hours' )
            // InternalAdeptness.g:4277:4: 'hours'
            {
             before(grammarAccess.getTimeTypeAccess().getTimeHoursKeyword_3_0()); 
    ...
    // InternalAdeptness.g:4288:1: rule__DataType__NameAssignment_1 : ( RULE_ID ) ;
    public final void rule__DataType__NameAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:4292:1: ( ( RULE_ID ) )
            // InternalAdeptness.g:4293:2: ( RULE_ID )
            {
            // InternalAdeptness.g:4293:2: ( RULE_ID )
            // InternalAdeptness.g:4294:3: RULE_ID
            {
    ...
    // InternalAdeptness.g:4303:1: rule__PackageDeclaration__NameAssignment_1 : ( ruleQualifiedName ) ;
    public final void rule__PackageDeclaration__NameAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:4307:1: ( ( ruleQualifiedName ) )
            // InternalAdeptness.g:4308:2: ( ruleQualifiedName )
            {
            // InternalAdeptness.g:4308:2: ( ruleQualifiedName )
            // InternalAdeptness.g:4309:3: ruleQualifiedName
            {
    ...
    // InternalAdeptness.g:4318:1: rule__PackageDeclaration__ElementsAssignment_3 : ( ruleAbstractElement ) ;
    public final void rule__PackageDeclaration__ElementsAssignment_3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalAdeptness.g:4322:1: ( ( ruleAbstractElement ) )
            // InternalAdeptness.g:4323:2: ( ruleAbstractElement )
            {
            // InternalAdeptness.g:4323:2: ( ruleAbstractElement )
            // InternalAdeptness.g:4324:3: ruleAbstractElement
            {
    ...
    static final String dfa_2s = "\1\42\1\5\1\uffff\1\5\1\22\1\5\3\uffff\1\41";
    static final String dfa_3s = "\1\45\1\54\1\uffff\1\5\1\46\1\5\3\uffff\1\46";
    ...
    public static final BitSet FOLLOW_3 = new BitSet(new long[]{0x0000600004090002L});
    ...
    public static final BitSet FOLLOW_15 = new BitSet(new long[]{0x0000100000000020L});
    ...
    public static final BitSet FOLLOW_24 = new BitSet(new long[]{0x00000B8000000000L});
    ...
    public static final BitSet FOLLOW_37 = new BitSet(new long[]{0x0001600004090000L});
