...
public class AdeptnessParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AdeptnessGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSameAccess().getTimesAssignment_2_0(), "rule__Same__TimesAssignment_2_0");
			builder.put(grammarAccess.getSameAccess().getTimesAssignment_2_1(), "rule__Same__TimesAssignment_2_1");
			builder.put(grammarAccess.getSameAccess().getTimesAssignment_2_2(), "rule__Same__TimesAssignment_2_2");
			builder.put(grammarAccess.getNotSameAccess().getBound_uppAssignment_1(), "rule__NotSame__Bound_uppAssignment_1");
			builder.put(grammarAccess.getNotSameAccess().getTimesAssignment_2_0(), "rule__NotSame__TimesAssignment_2_0");
			builder.put(grammarAccess.getNotSameAccess().getTimesAssignment_2_1(), "rule__NotSame__TimesAssignment_2_1");
			builder.put(grammarAccess.getNotSameAccess().getTimesAssignment_2_2(), "rule__NotSame__TimesAssignment_2_2");
			builder.put(grammarAccess.getUpperAccess().getBound_uppAssignment_1(), "rule__Upper__Bound_uppAssignment_1");
			builder.put(grammarAccess.getUpperAccess().getTimesAssignment_2_0(), "rule__Upper__TimesAssignment_2_0");
			builder.put(grammarAccess.getUpperAccess().getTimesAssignment_2_1(), "rule__Upper__TimesAssignment_2_1");
			builder.put(grammarAccess.getUpperAccess().getTimesAssignment_2_2(), "rule__Upper__TimesAssignment_2_2");
			builder.put(grammarAccess.getLowerAccess().getBound_lowerAssignment_1(), "rule__Lower__Bound_lowerAssignment_1");
			builder.put(grammarAccess.getLowerAccess().getTimesAssignment_2_0(), "rule__Lower__TimesAssignment_2_0");
			builder.put(grammarAccess.getLowerAccess().getTimesAssignment_2_1(), "rule__Lower__TimesAssignment_2_1");
			builder.put(grammarAccess.getLowerAccess().getTimesAssignment_2_2(), "rule__Lower__TimesAssignment_2_2");
			...
			builder.put(grammarAccess.getRangeAccess().getTimesAssignment_4_0(), "rule__Range__TimesAssignment_4_0");
			builder.put(grammarAccess.getRangeAccess().getTimesAssignment_4_1(), "rule__Range__TimesAssignment_4_1");
			builder.put(grammarAccess.getRangeAccess().getTimesAssignment_4_2(), "rule__Range__TimesAssignment_4_2");
			...
			builder.put(grammarAccess.getGapAccess().getTimesAssignment_4_0(), "rule__Gap__TimesAssignment_4_0");
			builder.put(grammarAccess.getGapAccess().getTimesAssignment_4_1(), "rule__Gap__TimesAssignment_4_1");
			builder.put(grammarAccess.getGapAccess().getTimesAssignment_4_2(), "rule__Gap__TimesAssignment_4_2");
