...
public class AdeptnessParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AdeptnessGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getCheckAccess().getReferenceAssignment_2(), "rule__Check__ReferenceAssignment_2");
			builder.put(grammarAccess.getCheckAccess().getFailReasonAssignment_3(), "rule__Check__FailReasonAssignment_3");
			builder.put(grammarAccess.getCheckAccess().getDescriptionAssignment_4(), "rule__Check__DescriptionAssignment_4");
			...
			builder.put(grammarAccess.getFailReasonAccess().getXPeaksAssignment_3_3(), "rule__FailReason__XPeaksAssignment_3_3");
			...
			builder.put(grammarAccess.getXPeaksAccess().getTimeAssignment_6(), "rule__XPeaks__TimeAssignment_6");
