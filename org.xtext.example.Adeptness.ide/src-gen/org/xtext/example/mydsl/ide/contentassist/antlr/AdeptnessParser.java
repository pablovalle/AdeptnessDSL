...
public class AdeptnessParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AdeptnessGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSameAccess().getAlternatives_2(), "rule__Same__Alternatives_2");
			builder.put(grammarAccess.getNotSameAccess().getAlternatives_2(), "rule__NotSame__Alternatives_2");
			builder.put(grammarAccess.getUpperAccess().getAlternatives_2(), "rule__Upper__Alternatives_2");
			builder.put(grammarAccess.getLowerAccess().getAlternatives_2(), "rule__Lower__Alternatives_2");
			builder.put(grammarAccess.getRangeAccess().getAlternatives_4(), "rule__Range__Alternatives_4");
			builder.put(grammarAccess.getGapAccess().getAlternatives_4(), "rule__Gap__Alternatives_4");
			builder.put(grammarAccess.getExactlyAccess().getAlternatives_2(), "rule__Exactly__Alternatives_2");
			builder.put(grammarAccess.getAt_mostAccess().getAlternatives_2(), "rule__At_most__Alternatives_2");
			builder.put(grammarAccess.getAt_leastAccess().getAlternatives_2(), "rule__At_least__Alternatives_2");
			...
			builder.put(grammarAccess.getValidationPlanAccess().getGroup(), "rule__ValidationPlan__Group__0");
			builder.put(grammarAccess.getValidationPlanAccess().getGroup_3(), "rule__ValidationPlan__Group_3__0");
			builder.put(grammarAccess.getTestAccess().getGroup(), "rule__Test__Group__0");
			builder.put(grammarAccess.getTestingOracleAccess().getGroup(), "rule__TestingOracle__Group__0");
			...
			builder.put(grammarAccess.getExactlyAccess().getGroup(), "rule__Exactly__Group__0");
			builder.put(grammarAccess.getExactlyAccess().getGroup_2_1(), "rule__Exactly__Group_2_1__0");
			builder.put(grammarAccess.getAt_mostAccess().getGroup(), "rule__At_most__Group__0");
			builder.put(grammarAccess.getAt_mostAccess().getGroup_2_1(), "rule__At_most__Group_2_1__0");
			builder.put(grammarAccess.getAt_leastAccess().getGroup(), "rule__At_least__Group__0");
			builder.put(grammarAccess.getAt_leastAccess().getGroup_2_1(), "rule__At_least__Group_2_1__0");
			...
			builder.put(grammarAccess.getValidationPlanAccess().getNameAssignment_1(), "rule__ValidationPlan__NameAssignment_1");
			builder.put(grammarAccess.getValidationPlanAccess().getSuperTypeAssignment_3_1(), "rule__ValidationPlan__SuperTypeAssignment_3_1");
			builder.put(grammarAccess.getValidationPlanAccess().getTestAssignment_4(), "rule__ValidationPlan__TestAssignment_4");
			builder.put(grammarAccess.getTestAccess().getNameAssignment_1(), "rule__Test__NameAssignment_1");
			builder.put(grammarAccess.getTestAccess().getSutAssignment_4(), "rule__Test__SutAssignment_4");
			builder.put(grammarAccess.getTestAccess().getTestLevelAssignment_7(), "rule__Test__TestLevelAssignment_7");
			builder.put(grammarAccess.getTestAccess().getInputsAssignment_10(), "rule__Test__InputsAssignment_10");
			builder.put(grammarAccess.getTestAccess().getOraclesAssignment_11(), "rule__Test__OraclesAssignment_11");
			builder.put(grammarAccess.getTestingOracleAccess().getNameAssignment_1(), "rule__TestingOracle__NameAssignment_1");
			builder.put(grammarAccess.getTestingOracleAccess().getTypeAssignment_4(), "rule__TestingOracle__TypeAssignment_4");
			builder.put(grammarAccess.getTestingOracleAccess().getParametersAssignment_7(), "rule__TestingOracle__ParametersAssignment_7");
			builder.put(grammarAccess.getParametersAccess().getValueAssignment_0(), "rule__Parameters__ValueAssignment_0");
			builder.put(grammarAccess.getInputsAccess().getValueAssignment_0(), "rule__Inputs__ValueAssignment_0");
			...
			builder.put(grammarAccess.getSameAccess().getExactlyAssignment_2_0(), "rule__Same__ExactlyAssignment_2_0");
			builder.put(grammarAccess.getSameAccess().getAtmostAssignment_2_1(), "rule__Same__AtmostAssignment_2_1");
			builder.put(grammarAccess.getSameAccess().getAtleastAssignment_2_2(), "rule__Same__AtleastAssignment_2_2");
			builder.put(grammarAccess.getNotSameAccess().getBound_uppAssignment_1(), "rule__NotSame__Bound_uppAssignment_1");
			builder.put(grammarAccess.getNotSameAccess().getExactlyAssignment_2_0(), "rule__NotSame__ExactlyAssignment_2_0");
			builder.put(grammarAccess.getNotSameAccess().getAtmostAssignment_2_1(), "rule__NotSame__AtmostAssignment_2_1");
			builder.put(grammarAccess.getNotSameAccess().getAtleastAssignment_2_2(), "rule__NotSame__AtleastAssignment_2_2");
			builder.put(grammarAccess.getUpperAccess().getBound_uppAssignment_1(), "rule__Upper__Bound_uppAssignment_1");
			builder.put(grammarAccess.getUpperAccess().getExactlyAssignment_2_0(), "rule__Upper__ExactlyAssignment_2_0");
			builder.put(grammarAccess.getUpperAccess().getAtmostAssignment_2_1(), "rule__Upper__AtmostAssignment_2_1");
			builder.put(grammarAccess.getUpperAccess().getAtleastAssignment_2_2(), "rule__Upper__AtleastAssignment_2_2");
			builder.put(grammarAccess.getLowerAccess().getBound_lowerAssignment_1(), "rule__Lower__Bound_lowerAssignment_1");
			builder.put(grammarAccess.getLowerAccess().getExactlyAssignment_2_0(), "rule__Lower__ExactlyAssignment_2_0");
			builder.put(grammarAccess.getLowerAccess().getAtmostAssignment_2_1(), "rule__Lower__AtmostAssignment_2_1");
			builder.put(grammarAccess.getLowerAccess().getAtleastAssignment_2_2(), "rule__Lower__AtleastAssignment_2_2");
			...
			builder.put(grammarAccess.getRangeAccess().getExactlyAssignment_4_0(), "rule__Range__ExactlyAssignment_4_0");
			builder.put(grammarAccess.getRangeAccess().getAtmostAssignment_4_1(), "rule__Range__AtmostAssignment_4_1");
			builder.put(grammarAccess.getRangeAccess().getAtleastAssignment_4_2(), "rule__Range__AtleastAssignment_4_2");
			...
			builder.put(grammarAccess.getGapAccess().getExactlyAssignment_4_0(), "rule__Gap__ExactlyAssignment_4_0");
			builder.put(grammarAccess.getGapAccess().getAtmostAssignment_4_1(), "rule__Gap__AtmostAssignment_4_1");
			builder.put(grammarAccess.getGapAccess().getAtleastAssignment_4_2(), "rule__Gap__AtleastAssignment_4_2");
			...
			builder.put(grammarAccess.getExactlyAccess().getValueAssignment_1(), "rule__Exactly__ValueAssignment_1");
			builder.put(grammarAccess.getExactlyAccess().getTimeAssignment_2_1_1(), "rule__Exactly__TimeAssignment_2_1_1");
			builder.put(grammarAccess.getExactlyAccess().getUnitAssignment_2_1_2(), "rule__Exactly__UnitAssignment_2_1_2");
			builder.put(grammarAccess.getExactlyAccess().getUnitAssignment_2_2(), "rule__Exactly__UnitAssignment_2_2");
			builder.put(grammarAccess.getAt_mostAccess().getValueAssignment_1(), "rule__At_most__ValueAssignment_1");
			builder.put(grammarAccess.getAt_mostAccess().getTimeAssignment_2_1_1(), "rule__At_most__TimeAssignment_2_1_1");
			builder.put(grammarAccess.getAt_mostAccess().getUnitAssignment_2_1_2(), "rule__At_most__UnitAssignment_2_1_2");
			builder.put(grammarAccess.getAt_mostAccess().getUnitAssignment_2_2(), "rule__At_most__UnitAssignment_2_2");
			builder.put(grammarAccess.getAt_leastAccess().getValueAssignment_1(), "rule__At_least__ValueAssignment_1");
			builder.put(grammarAccess.getAt_leastAccess().getTimeAssignment_2_1_1(), "rule__At_least__TimeAssignment_2_1_1");
			builder.put(grammarAccess.getAt_leastAccess().getUnitAssignment_2_1_2(), "rule__At_least__UnitAssignment_2_1_2");
			builder.put(grammarAccess.getAt_leastAccess().getUnitAssignment_2_2(), "rule__At_least__UnitAssignment_2_2");
