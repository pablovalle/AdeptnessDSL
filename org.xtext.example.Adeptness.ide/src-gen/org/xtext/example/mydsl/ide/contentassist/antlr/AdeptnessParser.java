...
public class AdeptnessParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AdeptnessGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getExpressionsModelAccess().getAlternatives_1(), "rule__ExpressionsModel__Alternatives_1");
			builder.put(grammarAccess.getAbstractElement2Access().getAlternatives_1(), "rule__AbstractElement2__Alternatives_1");
			builder.put(grammarAccess.getAbstractElement2Access().getAlternatives_2(), "rule__AbstractElement2__Alternatives_2");
			...
			builder.put(grammarAccess.getExpressionsModelAccess().getElementsAssignment_1_0(), "rule__ExpressionsModel__ElementsAssignment_1_0");
			...
			builder.put(grammarAccess.getAbstractElement2Access().getOperatorAssignment_2_0(), "rule__AbstractElement2__OperatorAssignment_2_0");
			builder.put(grammarAccess.getAbstractElement2Access().getComparationAssignment_2_1(), "rule__AbstractElement2__ComparationAssignment_2_1");
			builder.put(grammarAccess.getAbstractElement2Access().getLogicOperatorAssignment_2_2(), "rule__AbstractElement2__LogicOperatorAssignment_2_2");
